...
;(function($) {
        ...
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function(row) {
                if (row.is('TR')) {
                    ...
                    row.children(':last').append('<a class="" href="javascript:void(0)">' + options.deleteText + '<i class="'+options.deleteCssClass+'"></i></a>');
                } else if (row.is('UL') || row.is('OL')) {
                    // If they're laid out as an ordered/unordered list,
                    // insert an <li> after the last list item:
                    row.append('<li><a class="" href="javascript:void(0)">' + options.deleteText +'<i class="'+options.deleteCssClass+'"></i></a></li>');
                } else {
                    // Otherwise, just insert the remove button as the
                    // last child element of the form's container:
                    row.append('<a class="" href="javascript:void(0)">' + options.deleteText +'<i class="'+options.deleteCssClass+'"></i></a>');
                }
    ...
    $.fn.formset.defaults = {
        ...
        deleteCssClass: 'glyphicon glyphicon-trash',    // CSS class applied to the delete link
