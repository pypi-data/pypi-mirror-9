...
An implementation of the CSS box and flexbox layout algorithm.

Quickstart
----------

In your virtualenv, install Colosseum, and then run it::
...
If you're running Colosseum in a virtualenv, you'll need to set an
environment variable so that Colosseum can find the TCL graphics library::
...
Documentation for Colosseum can be found on `Read The Docs`_.
