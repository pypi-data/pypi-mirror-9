...
public:
    ...
    ::IceInternal::ProxyHandle<Process> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<Process*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
