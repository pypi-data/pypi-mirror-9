...
class ICE_API WSConnectionInfo : public ::Ice::IPConnectionInfo
{
public:
    ...
    WSConnectionInfo(bool __ice_incoming, const ::std::string& __ice_adapterName, const ::std::string& __ice_connectionId, const ::std::string& __ice_localAddress, ::Ice::Int __ice_localPort, const ::std::string& __ice_remoteAddress, ::Ice::Int __ice_remotePort) :
        ::Ice::IPConnectionInfo(__ice_incoming, __ice_adapterName, __ice_connectionId, __ice_localAddress, __ice_localPort, __ice_remoteAddress, __ice_remotePort)
