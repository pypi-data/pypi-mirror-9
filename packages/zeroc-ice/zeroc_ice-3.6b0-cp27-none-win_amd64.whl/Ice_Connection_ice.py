...
if 'WSConnectionInfo' not in _M_Ice.__dict__:
    ...
    class WSConnectionInfo(_M_Ice.IPConnectionInfo):
    ...
    _M_Ice._t_WSConnectionInfo = IcePy.defineClass('::Ice::WSConnectionInfo', WSConnectionInfo, -1, (), False, False, _M_Ice._t_IPConnectionInfo, (), ())
