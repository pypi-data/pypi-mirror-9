...
if 'WSEndpointInfo' not in _M_Ice.__dict__:
    ...
    class WSEndpointInfo(_M_Ice.IPEndpointInfo):
    ...
    _M_Ice._t_WSEndpointInfo = IcePy.defineClass('::Ice::WSEndpointInfo', WSEndpointInfo, -1, (), True, False, _M_Ice._t_IPEndpointInfo, (), (('resource', (), IcePy._t_string, False, 0),))
