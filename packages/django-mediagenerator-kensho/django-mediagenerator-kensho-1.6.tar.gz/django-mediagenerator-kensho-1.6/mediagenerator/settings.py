...
MEDIAGENERATOR_SASS_LIBRARY_FOLDERS = getattr(settings, 'MEDIAGENERATOR_SASS_LIBRARY_FOLDERS', [])

SEPARATE_DEV_SERVER = (MEDIA_DEV_MODE and
                       getattr(settings, 'MEDIAGENERATOR_SEPARATE_DEV_SERVER', False))
FLASK_STATIC_ROOT = '/dev-static/'
FLASK_SITE_ROOT = 'http://localhost:5000'  # TODO(martin): configure port.
