...
def range_brace(x_min, x_max, mid=0.75, beta1=50.0, beta2=100.0, height=1, initial_divisions=11, resolution_factor=1.5):
    """Generates a curly brace for plotting.

        y has a height of 1, so multiply y by a width, and add y to a position
        For vertical braces, just swap x and y.
        ...
        # Plot braces 10 units wide, and at 50 on y:
        ax.plot(x, y*10+50,'-')
