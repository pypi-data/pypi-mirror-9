...
from request_tree import __version__, __pkgname__
import os
...
setup(
    name             = __pkgname__,
    version          = __version__,
    description      = 'Provides dango views with input transformed into a tree structure.',
    long_description = description,
    author           = 'Martin Owens',
    url              = 'https://launchpad.net/~doctormo',
    author_email     = 'doctormo@gmail.com',
    platforms        = 'linux',
    license          = 'GPLv3',
    packages         = [ 'request_tree' ],
#    install_requires = [  ],
#    extras_require   = { 'validation': ['xsd-validator'] },
    classifiers      = [
