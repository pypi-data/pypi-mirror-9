...
-  `Device
   Client <http://iotf.readthedocs.org/en/latest/libraries/python_cli_for_devices.html>`__
-  `Application
   Client <http://iotf.readthedocs.org/en/latest/libraries/python_cli_for_apps.html>`__
