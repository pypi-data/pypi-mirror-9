...
class Iface:
  ...
  def append(self, test_name, report_tree):
    """
    Parameters:
     - test_name
     - report_tree
  ...
  def check_layout(self, webdriver_session_id, specs, included_tags, excluded_tags):
    """
    Parameters:
...
class Client(Iface):
  ...
  def register_test(self, test_name):
    ...
    Parameters:
     - test_name
    """
    self.send_register_test(test_name)
    self.recv_register_test()

  def send_register_test(self, test_name):
    self._oprot.writeMessageBegin('register_test', TMessageType.CALL, self._seqid)
    args = register_test_args()
    args.test_name = test_name
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_register_test(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
  ...
  def append(self, test_name, report_tree):
    ...
    Parameters:
     ...
     - report_tree
    """
    self.send_append(test_name, report_tree)
    self.recv_append()

  def send_append(self, test_name, report_tree):
    self._oprot.writeMessageBegin('append', TMessageType.CALL, self._seqid)
    args = append_args()
    args.test_name = test_name
    args.report_tree = report_tree
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()
  ...
  def check_layout(self, webdriver_session_id, specs, included_tags, excluded_tags):
    ...
    Parameters:
     ...
     - excluded_tags
    """
    self.send_check_layout(webdriver_session_id, specs, included_tags, excluded_tags)
    return self.recv_check_layout()

  def send_check_layout(self, webdriver_session_id, specs, included_tags, excluded_tags):
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["register_test"] = Processor.process_register_test
  ...
  def process_register_test(self, seqid, iprot, oprot):
    args = register_test_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = register_test_result()
    self._handler.register_test(args.test_name)
    oprot.writeMessageBegin("register_test", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_append(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = append_result()
    self._handler.append(args.test_name, args.report_tree)
  ...
  def process_check_layout(self, seqid, iprot, oprot):
    ...
    result = check_layout_result()
    try:
      result.success = self._handler.check_layout(args.webdriver_session_id, args.specs, args.included_tags, args.excluded_tags)
...
class register_test_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('register_test_args')
...
class register_test_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('register_test_result')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class append_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'test_name', None, None, ), # 1
    (2, TType.STRUCT, 'report_tree', (ReportTree, ReportTree.thrift_spec), None, ), # 2
  )

  def __init__(self, test_name=None, report_tree=None,):
    self.test_name = test_name
  ...
  def write(self, oprot):
    ...
    if self.report_tree is not None:
      oprot.writeFieldBegin('report_tree', TType.STRUCT, 2)
      self.report_tree.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.test_name)
    value = (value * 31) ^ hash(self.report_tree)
    return value
...
class check_layout_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'webdriver_session_id', None, None, ), # 1
    (2, TType.STRING, 'specs', None, None, ), # 2
    (3, TType.LIST, 'included_tags', (TType.STRING,None), None, ), # 3
    (4, TType.LIST, 'excluded_tags', (TType.STRING,None), None, ), # 4
  )

  def __init__(self, webdriver_session_id=None, specs=None, included_tags=None, excluded_tags=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i57 in xrange(_size53):
            ...
            self.included_tags.append(_elem58)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.LIST:
          ...
          for _i63 in xrange(_size59):
            ...
            self.excluded_tags.append(_elem64)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class check_layout_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (LayoutCheckReport, LayoutCheckReport.thrift_spec), None, ), # 0
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = LayoutCheckReport()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 1:
