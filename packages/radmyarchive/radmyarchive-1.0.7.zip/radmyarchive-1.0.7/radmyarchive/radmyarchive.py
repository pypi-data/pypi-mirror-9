...
import shutil
import time
import radmyarchive.radmyarchiveexceptions as radex
...
class RADMyArchive:
    ...
    def _fileOperation(self):
        if os.path.exists(self._destinationFilePath):
            raise radex.SameNamedFileExistError(self._destinationFilePath,
    ...
    def _createDestinationDirs(self):
        ...
        try:
            ...
            raise radex.CreateDirError(self._destinationBasePath,
    ...
    def _openImageFile(self):
        try:
            ...
            raise radex.FileNotFoundOrReadError(self._filePath,
    ...
    def _parseDateExif(self, tags):
        if 'EXIF DateTimeOriginal' not in tags.keys():
            if 'Image DateTime' in tags.keys():
                ...
                raise radex.DateTagNotExistError(self._filePath + " DateTimeOriginal TAG :",
                                                 "Tag Not Found")
        else:
