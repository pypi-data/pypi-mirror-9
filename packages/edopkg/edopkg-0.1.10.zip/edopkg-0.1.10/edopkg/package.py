    ...
    def push_obj(self, obj_cat, obj_folder, obj_filename):
        ...
        if obj_cat == 'script':
            ...
            try:
                ...
                print u'脚本代码 %s 存在错误，以下是错误信息：' % obj_filename
