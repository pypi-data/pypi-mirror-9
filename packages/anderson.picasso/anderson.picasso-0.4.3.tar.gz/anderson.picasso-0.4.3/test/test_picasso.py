...
class PicassoTest(unittest.TestCase):
    ...
    def test_extention(self):
        picasso = Picasso()
        picasso.open('test/width.jpg')
        self.assertEqual('JPEG', picasso.format)

    def test_copy(self):
        picasso1 = Picasso()
        picasso2 = picasso1.open('test/width.jpg').copy()
        self.assertIsNot(picasso1, picasso2)
        self.assertIsNot(picasso1._image, picasso2._image)
