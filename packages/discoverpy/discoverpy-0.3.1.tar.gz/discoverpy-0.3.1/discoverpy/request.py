...
class Request(wrappers.Request):
    ...
    def body(self):
        ...
        """
        query = self.args.to_dict(flat=False)
    ...
    @property
    def query(self):
        """Get a query container for the request."""
        return querylib.Query.from_string(self.query_string.decode('utf8'))
    ...
    def validate(self):
        ...
        if self.resource_method:
            ...
            getattr(self.resource.validator, self.resource_method)(self.body)
