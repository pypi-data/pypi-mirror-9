...
class Signal(object):
    ...
    def __init__(self, providing_args=None, use_caching=False):
        ...
        providing_args
            A list of the arguments this signal can pass along
            in a send() call.
        """
        self.receivers = []
    ...
    def connect(self, *args, **kwargs):
        ...
        Arguments:
            ...
            dispatch_uid
                ...
                anything hashable.
        """
        def _inner(sender=None, weak=True, dispatch_uid=None):
            def _connect_signal(fun):
                ...
                if weak:
                    ...
                    if (hasattr(receiver, '__self__') and
                            hasattr(receiver, '__func__')):
                        ref = WeakMethod
                        receiver_object = receiver.__self__
                    if sys.version_info >= (3, 4):
                        receiver = ref(receiver)
                        weakref.finalize(receiver_object,
                                         self._remove_receiver)
                    else:
        ...
        if args and callable(args[0]):
            return _inner(*args[1:], **kwargs)(args[0])
    ...
    def send(self, sender, **named):
        ...
        through send, terminating the dispatch loop, so it is
        quite possible to not have all receivers called
        if a raises an error.
    ...
    def _live_receivers(self, sender):
        ...
        if self.use_caching and not self._dead_receivers:
            ...
            # this case in .send() prior to calling _live_receivers()
            # due to concurrent .send() call.
