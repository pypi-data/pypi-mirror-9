...
def test_create():
    ...
    image = api.image_create("permanent test image", "image description", 1024*1024*10, 'permanent', disk_controllers[0], 'private')
...
def test_create_permanent_image():
    ...
    disk_controllers = api.supported_disk_controllers()
    image = api.image_create("permanent image", "image description", 1024*1024*10, 'permanent', disk_controllers[0], 'private')
