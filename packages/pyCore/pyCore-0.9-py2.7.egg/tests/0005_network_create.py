...
def test_network_create():
    ...
    network_public = api.network_create(24, "Normal Network", False)
    network_private = api.network_create(24, "Isolated Network", True)
...
def test_create_test_network():
    ...
    if not "Test public network" in names:
        api.network_create(24, "Test public network", False)
    if not "Test isolated network" in names:
        api.network_create(24, "Test isolated network", False)