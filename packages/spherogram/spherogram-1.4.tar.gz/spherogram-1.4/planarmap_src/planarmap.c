...
#endif
#include <math.h>
#define __PYX_HAVE__planarmap
#define __PYX_HAVE_API__planarmap
#include "string.h"
#include "stdlib.h"
#include "PMdef.h"
#include "PMplanmap.h"
...
static char __pyx_k_edge_connectivity[] = "edge_connectivity";
static char __pyx_k_Users_dunfield_Dropbox_Spherogr[] = "/Users/dunfield/Dropbox/Spherogram/planarmap_src/planarmap.pyx";
static char __pyx_k_Invalid_edge_connectivity_parame[] = "Invalid edge_connectivity parameter";
static PyObject *__pyx_kp_s_Invalid_edge_connectivity_parame;
...
static PyObject *__pyx_pw_9planarmap_1random_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("random_map (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_num_vertices)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_edge_connectivity);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Invalid_edge_connectivity_parame, __pyx_k_Invalid_edge_connectivity_parame, sizeof(__pyx_k_Invalid_edge_connectivity_parame), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initplanarmap(void); /*proto*/
PyMODINIT_FUNC initplanarmap(void)
#else
PyMODINIT_FUNC PyInit_planarmap(void); /*proto*/
PyMODINIT_FUNC PyInit_planarmap(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_planarmap(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("planarmap", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "planarmap")) {
      if (unlikely(PyDict_SetItemString(modules, "planarmap", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init planarmap", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init planarmap");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
