...
class XmlTestMixin(object):
    ...
    def assert_xml_document(self, data):
    ...
    def assert_xml_partial(self, partial_data, root_tag=None):
    ...
    def assert_xml_namespace(self, node, prefix, uri):
    ...
    def assert_xml_has_attribute(self, node, attribute, **kwargs):
    ...
    def assert_xml_node(self, node, **kwargs):
    ...
    def assert_xpaths_exist(self, node, xpaths):
    ...
    def assert_xpaths_only_one(self, node, xpaths):
    ...
    def assert_xpaths_unique_value(self, node, xpaths):
    ...
    def assert_xpath_values(self, node, xpath, values):
    ...
    def assert_xml_valid_dtd(self, node, dtd=None, filename=None):
    ...
    def assert_xml_valid_x_schema(self, node, xschema=None, filename=None,
                                  encoding='utf-8'):
    ...
    def assert_xml_valid_relaxng(self, node, relaxng=None,
    ...
    def assert_xml_equivalent_outputs(self, data, expected):
