...
static PyMethodDef _cffi_methods[] = {
  {"Cryptography_constant_time_bytes_eq", _cffi_f_Cryptography_constant_time_bytes_eq, METH_VARARGS, NULL},
...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_Cryptography_cffi_a8febd48xffc7b1ce",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__Cryptography_cffi_a8febd48xffc7b1ce(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_Cryptography_cffi_a8febd48xffc7b1ce(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Cryptography_cffi_a8febd48xffc7b1ce", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
