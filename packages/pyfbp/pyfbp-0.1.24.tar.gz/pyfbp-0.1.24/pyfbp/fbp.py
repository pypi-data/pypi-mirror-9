...
class FlowElement(object):
    local_debug=False
    def __init__(self,connector=None,method=None,connector_largs=[],connector_kwargs={},fname='undefined'):
        self.name=fname
        ...
        if type(self)!=NullProcessor:
            ...
            self.error_objects=[Printer('unhandled error in object:'+fname)]
