    ...
    spore.log("RP: "+required_params);
        ...
        api._call(fn,params,
                 ...
                 function(data, req, url){
                    ...
                    var button = $('.clipboardBtn', $('#'+fn+'_response'));
                    ClipboardCopyInit(button, raw_data);
                    ...
                    if(fn.indexOf("23D") != -1){
                    ...
                    else if(content_type.indexOf('application/json') != -1 || content_type.indexOf('text/javascript') != -1){
                        ...
                        if (typeof data == 'string' || data instanceof String)
                            ...
                            xml_str = new XMLSerializer().serializeToString(data.documentElement);
...
spore.api.prototype._call = function (fn, params, onsuccess, onerror) {
    var method = this.spec.methods[fn],
        url = (this.spec.base_url != undefined) ? this.spec.base_url + method.path : method.path,
        prm = $.extend({}, params),
