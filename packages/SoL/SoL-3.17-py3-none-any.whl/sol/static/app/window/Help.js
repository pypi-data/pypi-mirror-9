//-*- coding: utf-8 -*-
//:Progetto:  SoL -- Help window
//:Creato:    dom 29 dic 2013 09:09:51 CET
...
Ext.define('SoL.window.IFrame', {
    ...
    renderTpl: [
        '<iframe src="{src}" name="{frameName}" width="100%" height="100%" frameborder="0">',
        '</iframe>'
    ],
    ...
    getWin: function() {
        var me = this;
        return Ext.isIE ? me.iframeEl.dom.contentWindow : window.frames[me.frameName];
    },
    ...
    onLoad: function() {
        ...
        if (doc) {
            ...
            // We need to be sure we remove all our events from the iframe on unload or we're
            // going to LEAK!
