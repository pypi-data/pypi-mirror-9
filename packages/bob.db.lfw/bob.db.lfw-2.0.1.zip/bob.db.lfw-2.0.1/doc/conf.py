...
project = u'Labeled Faces in the Wild Database (Bob API)'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('bob.db.lfw')[0]
...
htmlhelp_basename = 'bob_db_lfw_doc'
