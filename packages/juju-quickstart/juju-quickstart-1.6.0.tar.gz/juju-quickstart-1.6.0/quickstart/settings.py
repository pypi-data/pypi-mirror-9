...
# The base charm store API URL containing information about charms.
# This URL must be formatted with a series and a charm name.
CHARMSTORE_API = (
    'https://api.jujucharms.com'
    '/charmstore/v4/{series}/{charm}/meta/id')
...
DEFAULT_CHARM_URLS = collections.OrderedDict((
    ('precise', 'cs:precise/juju-gui-104'),
    ('trusty', 'cs:trusty/juju-gui-16'),
))
