...
"""pyentity, a simple object-document mapper which wraps the mongodb driver - motor for python tornado applications."""
try:
    import tornado
except:
    raise ImportError(
...
from pyentity.entitymanager import EntityManager, EntityConnection
from pyentity import types
