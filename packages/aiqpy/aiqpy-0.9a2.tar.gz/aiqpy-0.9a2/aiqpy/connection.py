...
class Connection(object):
    ...
    def login(self):
        ...
        if hasattr(self, self.generate_private_variable_name('auth_params')):
    ...
    def __get_link(self, resource_path):
        ...
        traversed_path = []
        cache_key = self.__generate_cachekey(tuple(resource_path))
        ...
        while resource_path:
            ...
            if isinstance(data, list):
                ...
                for (key, link) in six.iteritems(data['links']):
                    self.__link_cache[self.__generate_cachekey(
    ...
    def __do_request(self,
        ...
        if not content_type and not parts:
            if isinstance(entity, dict):
                ...
                content_type = mimetypes.guess_type(entity.name)[0]
