...
from spot_setup_rosenbrock import spot_setup   # Imports the two dimensional Rosenbrock example
#from spot_setup_griewank import spot_setup   # Imports the two dimensional Rosenbrock example
...
if __name__ == '__main__':
    ...
    sampler.sample(100000)                # Sample 10.000 parameter combinations
