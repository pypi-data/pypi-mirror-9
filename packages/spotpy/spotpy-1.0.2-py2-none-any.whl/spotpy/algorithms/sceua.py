...
class sceua(_algorithm):
    ...
    def simulate(self,id_params_tuple):
        ...
        if not self.repeat.phase: #burn-in
            ...
            igs,x,xf,icall= id_params_tuple
    ...
    def sample(self,repetitions,ngs=20,kstop=100,pcento=0.0000001,peps=0.0000001):
        ...
        for rep,randompar,simulations in self.repeat(param_generator):        
            ...
            like = likelihoods.rmse(self.evaluation,simulations)
...
#        print '     '
        ...
        while icall<repetitions and gnrng>peps and criter_change>pcento:
            ...
            param_generator = ((rep,x,xf,icall) for rep in xrange(int(self.ngs))) 
            ...
            acttime=time.time()
            if acttime-intervaltime>=2:
                print '%i of %i (best like=%g)' % (icall,repetitions,self.status.likelihood)
                intervaltime=time.time()
...
#            print '     '
    ...
    def _cceua(self,s,sf,icall):
        ...
        like = likelihoods.rmse(simulation,self.evaluation)
        #like=-self.likelihood(simulation,self.evaluation)
