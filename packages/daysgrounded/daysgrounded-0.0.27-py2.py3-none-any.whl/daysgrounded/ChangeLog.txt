0.0.27 2015-03-28 ::
	...
	Changed licensing in all source files to comments instead of inside
    doctrings.
    Updated update_copyright() function in setup_utils.py to include
    build.cmd and COPYING.rst.
    Updated COPYING.rst.
    Updated build.cmd to auto upload docs, but it isn't working for the moment.
