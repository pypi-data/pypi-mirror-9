...
class SOAPServiceDescriptor(ServiceDescriptor):
	...
	def generate(self,servicename,servicenumber,typemanager,methodlist,service_url,encoding,**kw):
		...
		"""
		<schema xmlns="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified" targetNamespace="http://tempuri.org/">
			<import namespace="http://schemas.microsoft.com/2003/10/Serialization/Arrays"/>
			<!-- input message -->
			<element name="GetIntList">
			<complexType>
				<sequence/>
			</complexType>
			</element>
			<!-- output message -->
			<element name="GetIntListResponse">
			<complexType>
				<sequence>
				<element xmlns:q1="http://schemas.microsoft.com/2003/10/Serialization/Arrays" minOccurs="0" name="result" nillable="true" type="q1:ArrayOfint"/>
				</sequence>
			</complexType>
			</element>
		</schema>
		...
		for m in methodlist:
			...
			complextype.appendChild(sequence)
			for arg in m.args():
				# TODO: add the elements e.g. <element minOccurs="0" maxOccurs="unbounded" name="item" type="xsd:long"/>
				element = doc.createElement('element')
				sequence.appendChild(element)
		...
		"""
		<!-- input message -->
		<message name="GetIntList">
		<part name="parameters" element="tns:GetIntList"/>
		</message>
		<!-- output message -->
		<message name="GetIntListResponse">
		<part name="parameters" element="tns:GetIntListResponse"/>
		</message>
		"""
		...
		"""
		<binding name="MyService" type="tns:MyServicePortType">
		<SOAP:binding transport="http://schemas.xmlsoap.org/soap/http"/>
		<operation name="GetIntList">
		<SOAP:operation soapAction="http://192.168.1.23:8000/MyService/GetIntList" style="document"/>
		<input>
...
class DocumentLiteralSOAPInterface(BaseInterface):
	...
	@staticmethod
	def _interface_name():
		return ['soapdocumentliteral','soap']
