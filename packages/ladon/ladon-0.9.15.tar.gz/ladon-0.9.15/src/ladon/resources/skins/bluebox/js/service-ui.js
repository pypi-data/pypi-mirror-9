...
function callFormBuilder(service,method,options) {
	...
	run_button.click(function() {
		...
		service.callMethod(method,formToObject(),null,function(resp,reflection,fullresp) {
...
function init_service_ui(sname) {
	...
	service.loadDescription(sname+"/jsonwsp/description",function() {
		service.setViaProxy(true);
