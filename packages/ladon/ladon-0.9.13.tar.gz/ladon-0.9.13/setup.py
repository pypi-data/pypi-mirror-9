...
scriptfiles = [os.path.join('scripts',ladon_command)]
...
data_files= [
	(os.path.join('resources','skins','bluebox'),walk_dir(os.path.join('resources','skins','bluebox'))),
	(os.path.join('resources','skins','bluebox','css'),walk_dir(os.path.join('resources','skins','bluebox','css'))),
	(os.path.join('resources','skins','bluebox','js'),walk_dir(os.path.join('resources','skins','bluebox','js'))),
	(os.path.join('resources','skins','bluebox','images'),walk_dir(os.path.join('resources','skins','bluebox','images'))),
	(os.path.join('resources','skins','rounded'),walk_dir(os.path.join('resources','skins','rounded'))),
	(os.path.join('resources','skins','rounded','css'),walk_dir(os.path.join('resources','skins','rounded','css')))]
