...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.owner_content_type'
        db.add_column(u'odnoklassniki_discussions_comment', 'owner_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='odnoklassniki_comments_owners', to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Comment.owner_id'
        db.add_column(u'odnoklassniki_discussions_comment', 'owner_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=None, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.owner_content_type'
        db.delete_column(u'odnoklassniki_discussions_comment', 'owner_content_type_id')

        # Deleting field 'Comment.owner_id'
        db.delete_column(u'odnoklassniki_discussions_comment', 'owner_id')
