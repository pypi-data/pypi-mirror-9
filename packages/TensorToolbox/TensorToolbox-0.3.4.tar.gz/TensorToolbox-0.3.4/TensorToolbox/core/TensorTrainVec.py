...
class TTvec(storable_object):
    ...
    def __init__(self,A, 
        ...
        self.serialize_list.extend( ['TT', 'init', 'method', 'eps', 'max_ranks', 'multidim_point', 'rs', 'Js', 'Is', 'Js_last', 'Jinit', 'ltor_fiber_lists', 'rtol_fiber_lists', 'dmrg_not_converged', 'dmrg_sweep_it', 'dmrg_sweep_direction', 'dmrg_Pinv'] )
