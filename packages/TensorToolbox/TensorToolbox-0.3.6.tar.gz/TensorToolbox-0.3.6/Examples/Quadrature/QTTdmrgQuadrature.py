...
def runner(order, PLOTTING=False):
    ...
    # algorithm.
    STTapprox = DT.SQTT(f, X, params, orders=PolyOrd, method='ttdmrg',eps=eps)
    STTapprox.build()

    QTTapprox = STTapprox.generic_approx[0]
    ...
    if PLOTTING and d == 2:
        ...
        # Get last used idxs
        last_idxs = QTTapprox.get_ttdmrg_eval_idxs()
