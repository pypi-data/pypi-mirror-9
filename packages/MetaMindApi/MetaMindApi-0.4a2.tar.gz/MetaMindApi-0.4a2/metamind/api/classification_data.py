...
class ClassificationData:
    ...
    def add_samples(self, input_, is_tsv=False, unzip_on_client=True, verbose=True, skip_invalid_values=True, encoding='utf-8'):
        ...
        results = process_input_in_batches(url, input_, is_tsv, verbose=verbose, skip_invalid_values=skip_invalid_values, encoding=encoding)
