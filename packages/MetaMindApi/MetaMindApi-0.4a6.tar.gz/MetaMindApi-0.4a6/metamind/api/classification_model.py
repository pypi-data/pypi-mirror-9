...
class ClassificationModel:
    ...
    def predict(self, input_=None, input_type=None, dataset=None, unzip_on_client=True, skip_invalid_values=True, retry_on_timeout=True, encoding='utf-8'):
        """
        ...
        :param input_: This parameter can have multiple forms, illustrated by these examples:
            ...
            **Image Datasets**::
                 ...
                 predict("https://www.dropbox.com/sh/some/link?dl=0", input_type="dropbox")                                             # a public dropbox link
        ...
        :param input_type: The input format being used: 'files', 'urls', 'zip', 'dropbox', 'tsv' or 'text'. This parameter is required for all inputs other than datasets.
        ...
        if dataset:
            ...
            url=BASE_URL + '/api/v1.2/classifiers/' + str(self.id) + '/predict'
            results = process_input_in_batches(url, input_, input_type, unzip_on_client=unzip_on_client, skip_invalid_values=skip_invalid_values, encoding=encoding)
    ...
    def predict_proba(self, input_=None, input_type=None, dataset=None, unzip_on_client=True, skip_invalid_values=True, encoding='utf-8'):
        """
        ...
        :param input_: This parameter can have multiple forms, illustrated by these examples:
            ...
            **Image Datasets**::
                 ...
                 predict_proba("https://www.dropbox.com/sh/some/link?dl=0", input_type="dropbox")                                             # a public dropbox link
    ...
    def query_and_predict(self, query, encoding='utf-8'):
        """
    ...
    def query_and_predict_proba(self, query, encoding='utf-8'):
        """
