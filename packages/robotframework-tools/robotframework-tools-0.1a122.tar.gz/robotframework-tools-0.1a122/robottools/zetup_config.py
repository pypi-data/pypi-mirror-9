...
PACKAGES = ['robottools', 'robotshell', 'robottools.testrobot', 'robottools.remote', 'robottools.utils', 'robottools.library', 'robottools.library.context', 'robottools.library.keywords', 'robottools.library.inspector', 'robottools.library.session', 'robotshell.magic']
...
DISTRIBUTION = Distribution('robotframework-tools', 'robottools', '0.1a122')
