...
class PerlLangInfo(LangInfo):
    ...
    filename_patterns = ["Construct", "Conscript"]
...
class TclLangInfo(LangInfo):
    ...
    # check before "Bourne shell"
    _magic_number_precedence = ("Bourne shell", -1)
...
class CoffeeScriptLangInfo(_JSLikeLangInfo):
    ...
    keywords = _inherited_keywords.union(
        _compiler_reserved_words).union(_new_keywords)
