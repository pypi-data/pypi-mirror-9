...
class Role(Base):
    ...
    __tablename__ = 'roles'
    __table_args__ = (
        sa.UniqueConstraint('name', name='roles_uq_name'),
        )
...
class Permission(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['role_uuid'], ['roles.uuid'], name='permissions_fk_role'),
        )
...
class User(Base):
    ...
    __tablename__ = 'users'
    __table_args__ = (
        sa.ForeignKeyConstraint(['person_uuid'], ['people.uuid'], name='users_fk_person'),
        sa.UniqueConstraint('username', name='users_uq_username'),
        )
...
class UserRole(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['user_uuid'], ['users.uuid'], name='users_roles_fk_user'),
        sa.ForeignKeyConstraint(['role_uuid'], ['roles.uuid'], name='users_roles_fk_role'),
        )
