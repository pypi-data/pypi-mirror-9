...
class VendorContact(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['vendor_uuid'], ['vendors.uuid'], name='vendor_contacts_fk_vendor'),
        sa.ForeignKeyConstraint(['person_uuid'], ['people.uuid'], name='vendor_contacts_fk_person'),
        )
