...
class Subdepartment(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['department_uuid'], ['departments.uuid'], name='subdepartments_fk_department'),
        )
...
class Category(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['department_uuid'], ['departments.uuid'], name='categories_fk_department'),
        )
