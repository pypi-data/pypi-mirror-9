...
class Product(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['department_uuid'], ['departments.uuid'], name='products_fk_department'),
        sa.ForeignKeyConstraint(['subdepartment_uuid'], ['subdepartments.uuid'], name='products_fk_subdepartment'),
        sa.ForeignKeyConstraint(['category_uuid'], ['categories.uuid'], name='products_fk_category'),
        sa.ForeignKeyConstraint(['family_uuid'], ['families.uuid'], name='products_fk_family'),
        sa.ForeignKeyConstraint(['brand_uuid'], ['brands.uuid'], name='products_fk_brand'),
        sa.ForeignKeyConstraint(['report_code_uuid'], ['report_codes.uuid'], name='products_fk_report_code'),
        sa.ForeignKeyConstraint(['regular_price_uuid'], ['product_prices.uuid'], name='products_regular_price_uuid_fkey', use_alter=True),
        sa.ForeignKeyConstraint(['current_price_uuid'], ['product_prices.uuid'], name='products_current_price_uuid_fkey', use_alter=True),
        sa.Index('products_ix_upc', 'upc'),
        )
...
class ProductCode(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['product_uuid'], ['products.uuid'], name='product_codes_fk_product'),
        )
...
class ProductCost(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['product_uuid'], ['products.uuid'], name='product_costs_fk_product'),
        sa.ForeignKeyConstraint(['vendor_uuid'], ['vendors.uuid'], name='product_costs_fk_vendor'),
        )
    ...
    code = sa.Column(sa.String(length=15))
...
class ProductPrice(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['product_uuid'], ['products.uuid'], name='product_prices_fk_product'),
        )
