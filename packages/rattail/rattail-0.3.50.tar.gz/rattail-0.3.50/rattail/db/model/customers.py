...
class CustomerGroupAssignment(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['customer_uuid'], ['customers.uuid'], name='customers_groups_fk_customer'),
        sa.ForeignKeyConstraint(['group_uuid'], ['customer_groups.uuid'], name='customers_groups_fk_group'),
        )
...
class CustomerPerson(Base):
    ...
    __table_args__ = (
        sa.ForeignKeyConstraint(['customer_uuid'], ['customers.uuid'], name='customers_people_fk_customer'),
        sa.ForeignKeyConstraint(['person_uuid'], ['people.uuid'], name='customers_people_fk_person'),
        )
