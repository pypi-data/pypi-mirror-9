__title__ = 'fobi.contrib.plugins.form_elements.fields.hidden_model_object.forms'
__author__ = 'Artur Barseghyan <artur.barseghyan@gmail.com>'
__copyright__ = 'Copyright (c) 2014-2015 Artur Barseghyan'
__license__ = 'GPL 2.0/LGPL 2.1'
__all__ = ('HiddenModelObjectInputForm',)
...
from fobi.contrib.plugins.form_elements.fields.hidden_model_object.settings \
    import IGNORED_MODELS

theme = get_theme(request=None, as_instance=True)

class HiddenModelObjectInputForm(forms.Form, BaseFormFieldPluginForm):
    """
    Form for ``HiddenModelObjectPlugin``.
    """
    plugin_data_fields = [
        ("label", ""),
        ("name", ""),
