...
def push(data, code, name, authtoken='', desc='', override=False, verbose=False, text=None):
    ...
    if resp.status_code == 200 or resp.status_code == 422:
        ...
        error = ("Server Error. We apologize, something went wrong on our end. Please try call again in a minute, and email us at connect@quandl.com if this error persists.")
