#!/usr/bin/env python
"""
TEST.STDLIB.TEST_STATEMACHINE.PY -- test script for state machine class
...
from plib.stdlib.classes import StateMachine, InvalidState, InvalidInput, RecursiveTransition
