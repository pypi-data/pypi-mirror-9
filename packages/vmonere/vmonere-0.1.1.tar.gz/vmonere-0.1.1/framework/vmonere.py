...
from vmonere_command_line_utility import get_host_name, list_host_and_domain, show_domain_info, \
    ...
    load_balance, consolidate, get_ip, config_domain
...
def main(argv):
    ...
    config_parser = subparsers.add_parser('config',help='set up vmonere agent in domain')
    config_parser.add_argument('format', action = 'store', help ='get the format')
    config_parser.add_argument('file', action = 'store', help ='get the file')
    ...
    removedomain_parser = subparsers.add_parser('removedomain',help='remove the domain from vmonere')
    ...
    if args.subparser_name == 'config':
        #print 'Call config vmonere domain'
        file_format =args.format
        file_name = args.file
        config_domain(file_format,file_name)
    elif args.subparser_name == 'adddomain':
