...
def Segment_fromIter(*args) -> "Segment *" :
...
def Decoder_default_config() -> "Config *" :
  """Decoder_default_config() -> Config"""
  return _pocketsphinx.Decoder_default_config()

def Decoder_file_config(*args) -> "Config *" :
...
class NBestList(object):
    ...
    def __iter__(self) -> "NBestIterator *" :
