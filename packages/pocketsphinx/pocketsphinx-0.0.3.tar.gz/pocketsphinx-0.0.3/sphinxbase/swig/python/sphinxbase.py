...
class Config(object):
    ...
    def set_boolean(self, *args) -> "void" :
    ...
    def get_boolean(self, *args) -> "bool" :
...
class FrontEnd(object):
    ...
    def process_utt(self, *args) -> "int32" :
...
def JsgfRule_fromIter(*args) -> "JsgfRule *" :
...
def NGramModel_fromIter(*args) -> "NGramModel *" :
...
class NGramModelSet(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __iter__(self) -> "NGramModelSetIterator *" :
...
class Jsgf(object):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __iter__(self) -> "JsgfIterator *" :
