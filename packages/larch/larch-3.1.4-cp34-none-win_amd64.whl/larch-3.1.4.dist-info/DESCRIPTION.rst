...
For some unknown reason, Numpy is not available on PyPI as a wheel for Windows.  You will need to
download it `here <http://www.lfd.uci.edu/~gohlke/pythonlibs/#numpy>`_ and install it manually. You
will also need `pandas <http://www.lfd.uci.edu/~gohlke/pythonlibs/#pandas>`_.
