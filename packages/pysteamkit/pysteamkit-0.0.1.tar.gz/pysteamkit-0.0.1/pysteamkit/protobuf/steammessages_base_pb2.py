...
# source: steamclient/steammessages_base.proto
...
_CMSGPROTOBUFHEADER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ip', full_name='CMsgProtoBufHeader.ip', index=8,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='transport_error', full_name='CMsgProtoBufHeader.transport_error', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='messageid', full_name='CMsgProtoBufHeader.messageid', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='publisherid', full_name='CMsgProtoBufHeader.publisherid', index=12,
