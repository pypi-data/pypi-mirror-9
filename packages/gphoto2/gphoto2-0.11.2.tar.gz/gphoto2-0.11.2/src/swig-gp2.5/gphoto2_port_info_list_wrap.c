...
/*-----------------------------------------------
              @(target):= _gphoto2_port_info_list.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__gphoto2_port_info_list

#else
#  define SWIG_init    init_gphoto2_port_info_list

#endif
#define SWIG_name    "_gphoto2_port_info_list"
...
SWIGINTERN PyObject *_wrap_gp_port_info_get_type(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"gp_port_info_get_type",2,2,swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p__GPPortInfo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "gp_port_info_get_type" "', argument " "1"" of type '" "GPPortInfo""'"); 
  }
  arg1 = (GPPortInfo)(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_GPPortType, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "gp_port_info_get_type" "', argument " "2"" of type '" "GPPortType *""'"); 
  }
  arg2 = (GPPortType *)(argp2);
...
SWIGINTERN PyObject *_wrap_gp_port_info_list_free(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GPPortInfoList *arg1 = (GPPortInfoList *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "gp_port_info_list_free" "', argument " "1"" of type '" "GPPortInfoList *""'"); 
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gp_port_info_get_path", (PyCFunction)_wrap_gp_port_info_get_path, METH_O, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"gp_port_info_get_type", _wrap_gp_port_info_get_type, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"gp_port_info_list_new", (PyCFunction)_wrap_gp_port_info_list_new, METH_NOARGS, (char *)"gp_port_info_list_new() -> int"},
	 { (char *)"gp_port_info_list_free", (PyCFunction)_wrap_gp_port_info_list_free, METH_O, (char *)"\n"
		"gp_port_info_list_free(list) -> int\n"
		"\n"
		"Parameters:\n"
		"    list: PortInfoList *\n"
		"\n"
...
static PyHeapTypeObject SwigPyBuiltin___GPPortInfoList_type = {
  {
    ...
    0,                                        /* ob_size */
#endif
    "gphoto2.gphoto2_port_info_list.PortInfoList", /* tp_name */
    sizeof(SwigPyObject),                     /* tp_basicsize */
    0,                                        /* tp_itemsize */
