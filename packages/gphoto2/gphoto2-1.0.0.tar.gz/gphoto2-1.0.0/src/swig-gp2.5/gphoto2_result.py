...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_gphoto2_result', [dirname(__file__)])
        except ImportError:
            import _gphoto2_result
            return _gphoto2_result
        if fp is not None:
            try:
                _mod = imp.load_module('_gphoto2_result', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _gphoto2_result = swig_import_helper()
    del swig_import_helper
else:
    import _gphoto2_result
del version_info
from _gphoto2_result import *
try:
