...
__revision__ = "$Id: _clips_wrap.py 297 2008-02-22 17:56:26Z franzg $"
...
class Rule(object):
    ...
    def PrintMatches(self):
        ...
        logicalName = "temporary" if CLIPS_VERSION < '6.30' else "wdisplay"
        _c.routerClear(logicalName)
        _c.matches(logicalName, self.__defrule)
        s = _c.routerRead(logicalName)
        if s:
            _sys.stdout.write(s)
