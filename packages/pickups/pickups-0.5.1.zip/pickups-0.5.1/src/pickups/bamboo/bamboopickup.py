...
class BambooPickup(pickups.basepickup.BasePickup):
    ...
    def _update_overall_data(self):
        ...
        try:
            ...
            # TODO: log entry, save old value in properties, think of better handling this
            return False
    ...
    def update_data(self):
        ...
        return False if updated_overall is False or updated_builds is False else True
