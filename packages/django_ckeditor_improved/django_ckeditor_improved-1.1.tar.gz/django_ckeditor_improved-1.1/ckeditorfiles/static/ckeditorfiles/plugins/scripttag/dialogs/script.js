/*
 ...
 NOTE -- THIS DOESN"T WORK, it was something I was messing around with - nina@cgpartnersllc.com
*/
(function () {
    function c(b) {
    ...
    CKEDITOR.dialog.add("script", function (b) {
        var f = b.lang.script,
            a = b.lang.common,
        ...
        return {
            ...
            minHeight: 260,
            onShow: function () {
                this.fakeImage = this.scriptNode = null;
                var a = this.getSelectedElement();
                a && (a.data("cke-real-element-type") && "script" == a.data("cke-real-element-type")) && (this.fakeImage = a, this.scriptNode = a = b.restoreRealElement(a), this.setupContent(a))
            },
            onOk: function () {
                var a;
                a = this.fakeImage ? this.scriptNode : new CKEDITOR.dom.element("script");
                var c = {}, d = {};
                this.commitContent(a, c, d);
                a = b.createFakeElement(a, "cke_script", "script", !0);
                a.setAttributes(d);
                a.setStyles(c);
