...
def setup_product():
    ...
    import redturtle.custommenu.factories
    zcml.load_config('configure.zcml', redturtle.custommenu.factories)
    ...
    ztc.installPackage('redturtle.custommenu.factories')
...
setup_product()
ptc.setupPloneSite(products=['redturtle.custommenu.factories'])
