...
def cc_create_instance(group, owner=None, part_time=False, image_id='centos65x64d', cpu=1, memory=1024):
    """
    ...
    if not key_id:
        raise Exception("ssh-key not found from user:{}".format(owner))
