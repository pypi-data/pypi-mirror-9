...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Poll', fields ['fetched']
        db.create_index(u'vkontakte_polls_poll', ['fetched'])

        # Adding index on 'Poll', fields ['votes_count']
        db.create_index(u'vkontakte_polls_poll', ['votes_count'])

        # Adding index on 'Poll', fields ['owner_id']
        db.create_index(u'vkontakte_polls_poll', ['owner_id'])

        # Adding index on 'Answer', fields ['fetched']
        db.create_index(u'vkontakte_polls_answer', ['fetched'])

        # Adding index on 'Answer', fields ['votes_count']
        db.create_index(u'vkontakte_polls_answer', ['votes_count'])


    def backwards(self, orm):
        # Removing index on 'Answer', fields ['votes_count']
        db.delete_index(u'vkontakte_polls_answer', ['votes_count'])

        # Removing index on 'Answer', fields ['fetched']
        db.delete_index(u'vkontakte_polls_answer', ['fetched'])

        # Removing index on 'Poll', fields ['owner_id']
        db.delete_index(u'vkontakte_polls_poll', ['owner_id'])

        # Removing index on 'Poll', fields ['votes_count']
        db.delete_index(u'vkontakte_polls_poll', ['votes_count'])

        # Removing index on 'Poll', fields ['fetched']
        db.delete_index(u'vkontakte_polls_poll', ['fetched'])
    ...
    models = {
        ...
        u'vkontakte_polls.answer': {
            ...
            'votes_count': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})
        },
        u'vkontakte_polls.poll': {
            ...
            'owner_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
