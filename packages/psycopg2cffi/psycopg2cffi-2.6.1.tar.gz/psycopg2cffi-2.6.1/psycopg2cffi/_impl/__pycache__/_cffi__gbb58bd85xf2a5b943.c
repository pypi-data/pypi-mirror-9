...
double _cffi_f_PQEgetdouble(PGresult const * x0, int x1, int x2)
{
  return PQEgetdouble(x0, x1, x2);
}

float _cffi_f_PQEgetfloat(PGresult const * x0, int x1, int x2)
{
  return PQEgetfloat(x0, x1, x2);
}

int _cffi_f_PQEgetint(PGresult const * x0, int x1, int x2)
{
  return PQEgetint(x0, x1, x2);
}

long _cffi_f_PQEgetlong(PGresult const * x0, int x1, int x2)
{
  return PQEgetlong(x0, x1, x2);
}
