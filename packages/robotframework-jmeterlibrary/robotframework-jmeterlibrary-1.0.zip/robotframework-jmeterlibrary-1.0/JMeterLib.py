...
def runJmeterAnalyseJtlConvert(jmeterPath, testPlanPath, logFilePath, otherParams=""):
    """
    ...
    """
    JMeterRunner(jmeterPath, testPlanPath, logFilePath, otherParams)
    lai = LogAnalysisInitiator(logFilePath, True, True)
    return lai.getReturnStructure()

def runJmeterAnalyseJtlConvertToDb(jmeterPath, testPlanPath, logFilePath, otherParams=""):
    """
...
def runJmeterAnalyseJtlConvertToHtml(jmeterPath, testPlanPath, logFilePath, otherParams=""):
    """
    ...
    """
    JMeterRunner(jmeterPath, testPlanPath, logFilePath, otherParams)
    lai = LogAnalysisInitiator(logFilePath, createHtmlReport=True)
    return lai.getReturnStructure()

def runJmeterAnalyseJtl(jmeterPath, testPlanPath, logFilePath, otherParams=""):
    """
...
def analyseJtlConvert(logFilePath):
    """
...
def analyseJtlConvertToDb(logFilePath):
    """
...
def analyseJtlConvertToHtml(logFilePath):
    """
...
class LogAnalysisInitiator(object):
    def __init__(self, filePath, createSqlReport=False, createHtmlReport=False):
        debugNeeded = False
