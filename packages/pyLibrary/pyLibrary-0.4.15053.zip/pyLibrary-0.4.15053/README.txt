...
-  `Converting data, i/o JSON, and using
   templates <https://github.com/klahnakoski/pyLibrary/tree/master/pyLibrary>`__
-  `Manipulating
   Datastructures <https://github.com/klahnakoski/pyLibrary/tree/master/pyLibrary/dot>`__
-  `Logging and Exception
   Handling <https://github.com/klahnakoski/pyLibrary/tree/master/pyLibrary/debugs>`__
-  `Connecting to your
