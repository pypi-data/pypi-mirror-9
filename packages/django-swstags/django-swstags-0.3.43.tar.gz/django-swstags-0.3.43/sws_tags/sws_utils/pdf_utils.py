...
def wkhtmltopdf(pages, output='media/reg/test2.pdf', **kwargs):
	"""
...
def render_to_pdf(template_name, dictionary=None, context_instance=None, header_template=None, footer_template=None,filename=None, **kwargs):
	...
	content = wkhtmltopdf([page_path],filename, **kwargs)
...
JS_PATH  = '/home/msanchez/projects/ooint/static/js/htmlToPdf.js'
