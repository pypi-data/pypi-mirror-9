...
def tag_filters_select2(view_name,dimension_filters,URL_FILTERS_CUVE,shortcuts='false',vertical='false',day_from=1,name=''):
	return {'view_name':view_name,'dimension_filters': dimension_filters,'URL_FILTERS_CUVE':URL_FILTERS_CUVE ,'shortcuts':shortcuts,'vertical':vertical,'day_from':day_from,'name':name}
...
def tag_shortcuts(view_name,shortcuts=None,shortcuts_select='today'):
	...
	shortcuts_order = ['10m','30m','1h','3h', '24h', 'today','yesterday','week','lastseven','pweek','month','lastthirty','pmonth','all']
