...
def reloadRequest(request_data,request):  
    ...
    request_data ['system_tz'] = str(request.session['system_tz'])
    ...
    request_data['from_calldate'] = request_data['from_Date'] # this is necesary for the older filters
    request_data['to_calldate'] = request_data['to_Date']

    # print '------------------------------------------------------------'
    # if 'from_calldate' in request_data:
    #     print '----from_calldate--->',request_data['from_calldate']
    # if 'to_calldate' in request_data:
    #     print '----to_calldate----->',request_data['to_calldate']

    # print '----from_Date_user--->',request_data['from_Date_user']
    # print '----to_Date_user---->',request_data['to_Date_user']
    # print '----from_Date------->',request_data['from_Date']
    # print '----to_Date--------->',request_data['to_Date']
