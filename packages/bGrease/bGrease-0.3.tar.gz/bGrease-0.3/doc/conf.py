# -*- coding: utf-8 -*-
#
# Grease documentation build configuration file, created by
# sphinx-quickstart on Sat Feb  6 16:58:46 2010.
#
...
latex_documents = [
  ('index', 'Grease.tex', u'Grease Documentation',
