...
"""
__all__ = ['arrow_serializer',
           'BaseClock', 'AsyncioClock', 'ExternalClock', 'TimerHandle']
...
class ExternalClock(BaseClock):
    ...
    """
    def __init__(self, utc_start, init_time=0):
        if type(utc_start) is not arrow.arrow.Arrow:
