...
class TileEntity(nbtobject.NBTObject, metaclass=entity.EntityMeta):
    ...
    def __repr__(self):
        ...
        return '<{}: id={!r}>'.format(name, self.id)
...
class Beacon(TileEntity, id='minecraft:Beacon'):
    """A beacon."""
...
class Cauldron(Container, id='minecraft:Cauldron'):
...
class Chest(Container, id='minecraft:Chest'):
...
class Comparator(TileEntity, id='minecraft:Comparator'):
    """A comparator."""
...
class Control(Container, id='minecraft:Control'):
    """A control block."""
...
class DaylightSensor(TileEntity, id='minecraft:DLDetector'):
    """A daylight sensor."""
    pass


class EndPortal(TileEntity, id='minecraft:Airportal'):
    """An end portal."""
    pass


class FlowerPot(TileEntity, id='minecraft:FlowerPot'):
    """A flower pot."""
...
class Furnace(Container, id='minecraft:Furnace'):
    """A furnace."""
...
class Hopper(Container, id='minecraft:Hopper'):
    """A hopper."""
    items = fields.ObjectListField('Items', item.Item)
...
class Spawner(TileEntity, id='minecraft:MobSpawner'):
    """A mob spawner."""
...
class Music(TileEntity, id='minecraft:Music'):
    """A music block."""
...
class Piston(TileEntity, id='minecraft:Piston'):
    """A piston."""
...
class RecordPlayer(TileEntity, id='minecraft:RecordPlayer'):
    """A jukebox."""
...
class Sign(TileEntity, id='minecraft:Sign'):
    """A sign."""
...
class Skull(TileEntity, id='minecraft:Skull'):
...
class Dropper(AbstractDispenser, id='minecraft:Dropper'):
    """A dropper."""
    pass


class Dispenser(AbstractDispenser, id='minecraft:Trap'):
    """A dispenser."""
    pass
