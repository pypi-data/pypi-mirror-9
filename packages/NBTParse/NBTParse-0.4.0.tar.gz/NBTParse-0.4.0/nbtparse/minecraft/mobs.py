...
class HealthField(fields.MultiField):
    ...
    def __repr__(self):
        ...
        return 'HealthField({!r}, {!r}, default={!r})'.format(short_name,
                                                              float_name,
                                                              self.default)
    @staticmethod
...
class Blaze(Mob, id='minecraft:Blaze'):
    """A blaze.
...
class Creeper(Mob, id='minecraft:Creeper'):
...
class CaveSpider(Mob, id='minecraft:CaveSpider'):
    """A cave spider.
...
class EnderDragon(Mob, id='minecraft:EnderDragon'):
    """The Ender Dragon.
...
class Ghast(Mob, id='minecraft:Ghast'):
    """A ghast.
...
class Giant(Mob, id='minecraft:Giant'):
    """A giant.
...
class Slime(Mob, id='minecraft:Slime'):
    """A slime.
...
class MagmaCube(Slime, id='minecraft:LavaSlime'):
    """A magma cube.
...
class Silverfish(Mob, id='minecraft:Silverfish'):
    """A silverfish.
...
class Skeleton(Mob, id='minecraft:Skeleton'):
    """A skeleton.
...
class Spider(Mob, id='minecraft:Spider'):
    """A spider.
...
class Witch(Mob, id='minecraft:Witch'):
    """A witch.
...
class Wither(Mob, id='minecraft:WitherBoss'):
    """A wither.
...
class Zombie(Mob, id='minecraft:Zombie'):
    """A zombie.
...
class Enderman(Mob, id='minecraft:Enderman'):
    """An enderman.
...
class Wolf(Breedable, Tameable, id='minecraft:Wolf'):
    angry = fields.BooleanField('Angry')
    collar_color = fields.ByteField('CollarColor')


class ZombiePigman(Zombie, id='minecraft:PigZombie'):
    anger = fields.ShortField('Anger')


class Bat(Mob, id='minecraft:Bat'):
    """A bat.
...
class Chicken(Breedable, id='minecraft:Chicken'):
    """A chicken.
...
class Cow(Breedable, id='minecraft:Cow'):
    """A cow.
...
class Mooshroom(Breedable, id='minecraft:MushroomCow'):
...
class Horse(Breedable, id='minecraft:EntityHorse'):
    """A horse.
...
class Ocelot(Tameable, Breedable, id='minecraft:Ozelot'):
    """An ocelot.
...
class Pig(Breedable, id='minecraft:Pig'):
    """A pig.
...
class Sheep(Breedable, id='minecraft:Sheep'):
    """A sheep.
...
class Squid(Mob, id='minecraft:Squid'):
    """A squid.
...
class Offer(nbtobject.NBTObject):
    ...
    def __repr__(self):
        return ('<Offer: buy={!r}, secondary={!r}, sell={!r}>'
                .format(self.buy, self.buy_secondary, self.sell))
...
class Villager(Breedable, id='minecraft:Villager'):
    """A villager.
...
class SnowGolem(Mob, id='minecraft:SnowMan'):
...
class IronGolem(Mob, id='minecraft:VillagerGolem'):
    """An iron golem.
