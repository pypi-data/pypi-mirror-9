...
class Egg(Projectile, id='minecraft:Egg'):
    """A thrown egg."""
    pass


class Arrow(Projectile, id='minecraft:Arrow'):
    """An arrow.
...
class Fireball(AbstractFireball, id='minecraft:Fireball'):
    """A regular fireball."""
    pass


class SmallFireball(AbstractFireball, id='minecraft:SmallFireball'):
    """A small fireball."""
    pass


class WitherSkull(AbstractFireball, id='minecraft:WitherSkull'):
    """A wither skull."""
    pass
...
class ThrownEnderpearl(Thrown, id='minecraft:ThrownEnderpearl'):
    """A thrown enderpearl.
...
class ThrownExpBottle(Thrown, id='minecraft:ThrownExpBottle'):
    """A thrown Bottle o' Enchanting."""
    pass


class ThrownPotion(Thrown, id='minecraft:ThrownPotion'):
    """A thrown splash potion."""
    potion = fields.NBTObjectField('Potion', item.Item)
    potion_value = fields.IntField('potionValue')


class ThrownSnowball(Thrown, id='minecraft:Snowball'):
    """A thrown snowball."""
    pass
