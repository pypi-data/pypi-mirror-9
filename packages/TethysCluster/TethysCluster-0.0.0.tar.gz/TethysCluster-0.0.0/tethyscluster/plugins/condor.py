...
class CondorPlugin(clustersetup.DefaultClusterSetup):
    ...
    def _add_condor_node(self, node):
        ...
        start_condor_cmd = '/etc/init.d/condor start' or 'condor_master' or 'net start condor' #TODO find a way to determine which start command is needed
        node.ssh.execute(start_condor_cmd)
