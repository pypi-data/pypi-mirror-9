...
class Cluster(object):
    ...
    def setup_cluster(self):
        ...
        TethysCluster setup routines followed by any additional plugin setup
        routines
        """
    ...
    def _setup_cluster(self):
        """
        Runs the default TethysCluster setup routines followed by any additional
    ...
    def validate_userdata(self):
        ...
        if ud_size_kb > 16:
            raise exception.ClusterValidationError(
                ...
                "NOTE: TethysCluster uses anywhere from 0.5-2KB "
