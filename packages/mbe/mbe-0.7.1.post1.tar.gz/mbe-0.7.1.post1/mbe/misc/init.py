...
def get_empty_db_da(_database_name, _json_schema_folders=None):
    """
    ...
    return DatabaseAccess(_database=_database, _json_schema_folders=_json_schema_folders)
...
def init_database(_database_name="test_database", _data_files=None, _json_schema_folders=None):
    """
    ...
    _da = get_empty_db_da(_database_name, _json_schema_folders)
