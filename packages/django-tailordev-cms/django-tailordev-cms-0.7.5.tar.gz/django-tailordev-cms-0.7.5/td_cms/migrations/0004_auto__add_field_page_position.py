...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.position'
        db.add_column(u'td_cms_page', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.position'
        db.delete_column(u'td_cms_page', 'position')
    ...
    models = {
        ...
        u'td_cms.page': {
            'Meta': {'ordering': "['position', '-id']", 'object_name': 'Page'},
            'allow_comments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'categories': ('mptt.fields.TreeManyToManyField', [], {'related_name': "'page'", 'symmetrical': 'False', 'to': u"orm['td_cms.Category']"}),
