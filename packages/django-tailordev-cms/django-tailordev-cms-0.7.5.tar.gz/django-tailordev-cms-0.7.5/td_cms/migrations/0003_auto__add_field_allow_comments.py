...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.allow_comments'
        db.add_column(u'td_cms_page', 'allow_comments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.allow_comments'
        db.delete_column(u'td_cms_page', 'allow_comments')
