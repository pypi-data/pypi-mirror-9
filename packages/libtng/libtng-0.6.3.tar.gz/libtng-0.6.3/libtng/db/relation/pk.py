...
class ColumnDoesNotExist(AttributeError):
    pass
...
class PrimaryKey(object):
    ...
    def __init__(self, cls):
        ...
        self._columns = [x for x in self._mapper.primary_key]
    ...
    def __repr__(self):
        return 'PrimaryKey({0})'.format(self._class.__name__)


class InstancePrimaryKey(PrimaryKey):
    """
    Represents the primary key of a :class:`~libtng.db.relation.Relation`
    *instance*.
    """
    ...
    def __init__(self, instance):
        ...
        PrimaryKey.__init__(self, type(instance))
    ...
    def update(self, returning=None):
        ...
        object matching the tuple identified by the primary
        key.
        """
    ...
    def as_dict(self):
        """
        Returns the column names and their values as a :class:`dict`.
        """
        return {x.key: getattr(self._instance, x.key)
    ...
    def is_valid(self):
        """
        Returns a boolean indicating if the primary key is valid.
    ...
    def __repr__(self):
        return 'InstancePrimaryKey({0})'.format(self._class.__name__)
...
class PrimaryKeyDescriptor(object):
    ...
    def __get__(self, instance, cls):
        return PrimaryKey(cls) if not instance\
            else InstancePrimaryKey(instance)