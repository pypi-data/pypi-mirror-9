...
from pretend_extended.server.apps.pretender import get_pretenders

try:
    from collections import OrderedDict
except ImportError:
    # 2.6 compatibility
    from pretend_extended.common.compat.ordered_dict import OrderedDict

from collections import defaultdict

from pretend_extended.server.log import get_logger
from pretend_extended.common.constants import FOREVER
from pretend_extended.common.http import Preset, match_rule_from_dict
from pretend_extended.server import app

LOGGER = get_logger('pretend_extended.server.apps.preset')
