...
from pretend_extended.server.base import in_parent_process, save_pid_file
from pretend_extended.server import data, pretender_app, settings
from pretend_extended.server.maintain import launch_maintainer

LOGGER = get_logger('pretend_extended.server.server')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=120,
        help='timeout before deleting stale pretend_extended')
