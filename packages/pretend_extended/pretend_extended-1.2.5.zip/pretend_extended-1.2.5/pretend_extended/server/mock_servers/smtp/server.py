...
from pretend_extended.common.smtp import SMTPSerialiser
from pretend_extended.server.pretender import Pretender


LOGGER = get_logger('pretend_extended.server.mock_servers.smtp.server')
