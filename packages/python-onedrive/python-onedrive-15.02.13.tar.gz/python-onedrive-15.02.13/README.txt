...
API <http://msdn.microsoft.com/library/dn659752.aspx>`__.
...
-  Since 2015-02-24, there is a new `"api.onedrive.com/v1.0"
   ...
   This is not (yet?) supported in any way, and basically needs a new
   module for it, which might be available elsewhere.
