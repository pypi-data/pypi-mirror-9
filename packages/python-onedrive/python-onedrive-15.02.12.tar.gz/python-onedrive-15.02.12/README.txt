...
Only old "apis.live.net/v5.0" (SkyDrive) API and BITS are used. Since 24
Feb 2015, there is new "api.onedrive.com/v1.0" API (`on
...
is not yet supported in any way.
...
`DevCenter <https://account.live.com/developers/applications/create>`__,
...
-  Since 2015-02-24, there is a new `"api.onedrive.com/v1.0"
   API <https://onedrive.github.io/>`__, which allows to do a lot more
   than the old one.

   This is not yet supported in any way, and requires rewriting the
   module from scratch for it.

   See also
   `issue-52 <https://github.com/mk-fg/python-onedrive/issues/52>`__.
