...
import urllib.request, urllib.parse, urllib.error      # handling of url downloads
...
def find_newest_library(verbose=False, old=False):
    ...
    if old:
        ...
        bufr_lib_versions = []
        urlf = urllib.request.urlopen(url_bufr_page)
...
def download_bufrlib_sources(download_url, ecmwf_bufr_lib_dir,
    ...
    try:
        ...
        urlf = urllib.request.urlopen(download_url)
    except IOError:
