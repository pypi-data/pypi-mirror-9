...
#            raise IOError
    ...
    def add_c_table_entry(self,lineblock):
        ...
        # verify consistency of C table definition
        if num_flags != len(list(fldef.flag_dict.keys())):
            if self.report_warnings:
                ...
                print(('found number of unique flag values = {}'.
                      format(len(list(fldef.flag_dict.keys())))))
                # if num_flags==0:
    ...
    def print_B_table(self):
        #  #[
        ref_list = list(self.table_b.keys())
        ref_list.sort()
        for ref in ref_list:
    ...
    def print_C_table(self):
        #  #[
        ref_list = list(self.table_c.keys())
    ...
    def print_D_table(self):
        #  #[
        ref_list = list(self.table_d.keys())
        for ref in sorted(ref_list):
    ...
    def write_C_table(self, fd):
        ...
        ref_list = list(self.table_c.keys())
        for ref in sorted(ref_list):
            flag_values = list(self.table_c[ref].flag_dict.keys())
