...
\n\
Calculates the direct FFT of a 1D array/signal. Input and output\n\
arrays are 1D NumPy arrays of type ``complex128``.\n\
"
);

/**
 * Represents either an FFT1D
 */
typedef struct {
  PyObject_HEAD
  bob::sp::FFT1D* cxx;
...
extern PyTypeObject PyBobSpFFT1D_Type; //forward declaration

int PyBobSpFFT1D_Check(PyObject* o) {
  return PyObject_IsInstance(o, reinterpret_cast<PyObject*>(&PyBobSpFFT1D_Type));
}

static void PyBobSpFFT1D_Delete (PyBobSpFFT1DObject* o) {
...
static int PyBobSpFFT1D_InitCopy
(PyBobSpFFT1DObject* self, PyObject* args, PyObject* kwds) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!", kwlist,
        &PyBobSpFFT1D_Type, &other)) return -1;

  auto copy = reinterpret_cast<PyBobSpFFT1DObject*>(other);
...
static int PyBobSpFFT1D_InitShape(PyBobSpFFT1DObject* self, PyObject *args,
    PyObject* kwds) {
...
static int PyBobSpFFT1D_Init(PyBobSpFFT1DObject* self,
...
static PyObject* PyBobSpFFT1D_RichCompare (PyBobSpFFT1DObject* self,
...
static PyObject* PyBobSpFFT1D_GetLength
(PyBobSpFFT1DObject* self, void* /*closure*/) {
  return Py_BuildValue("n", self->cxx->getLength());
}

static int PyBobSpFFT1D_SetLength
(PyBobSpFFT1DObject* self, PyObject* o, void* /*closure*/) {
...
static PyObject* PyBobSpFFT1D_GetShape
(PyBobSpFFT1DObject* self, void* /*closure*/) {
  return Py_BuildValue("(n)", self->cxx->getLength());
}

static int PyBobSpFFT1D_SetShape
(PyBobSpFFT1DObject* self, PyObject* o, void* /*closure*/) {
...
static PyObject* PyBobSpFFT1D_Call
(PyBobSpFFT1DObject* self, PyObject* args, PyObject* kwds) {
...
PyTypeObject PyBobSpFFT1D_Type = {
    ...
    s_fft1d_str,                              /*tp_name*/
    sizeof(PyBobSpFFT1DObject),               /*tp_basicsize*/
    0,                                        /*tp_itemsize*/
    (destructor)PyBobSpFFT1D_Delete,          /*tp_dealloc*/
    0,                                        /*tp_print*/
    0,                                        /*tp_getattr*/
    0,                                        /*tp_setattr*/
    0,                                        /*tp_compare*/
    (reprfunc)PyBobSpFFT1D_Repr,              /*tp_repr*/
    0,                                        /*tp_as_number*/
    0,                                        /*tp_as_sequence*/
    0,                                        /*tp_as_mapping*/
    0,                                        /*tp_hash */
    (ternaryfunc)PyBobSpFFT1D_Call,           /* tp_call */
    (reprfunc)PyBobSpFFT1D_Repr,              /*tp_str*/
    0,                                        /*tp_getattro*/
    0,                                        /*tp_setattro*/
    0,                                        /*tp_as_buffer*/
    ...
    0,		                                    /* tp_traverse */
    0,		                                    /* tp_clear */
    (richcmpfunc)PyBobSpFFT1D_RichCompare,    /* tp_richcompare */
    0,		                                    /* tp_weaklistoffset */
    0,		                                    /* tp_iter */
    0,		                                    /* tp_iternext */
    0,                                        /* tp_methods */
    0,                                        /* tp_members */
    PyBobSpFFT1D_getseters,                   /* tp_getset */
    0,                                        /* tp_base */
    0,                                        /* tp_dict */
    0,                                        /* tp_descr_get */
    0,                                        /* tp_descr_set */
    0,                                        /* tp_dictoffset */
    (initproc)PyBobSpFFT1D_Init,              /* tp_init */
    0,                                        /* tp_alloc */
    0,                                        /* tp_new */
};
