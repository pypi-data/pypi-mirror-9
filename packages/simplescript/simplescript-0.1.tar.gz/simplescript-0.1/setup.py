...
setup(
    name="simplescript",
    version=exec_file(("simplescript.py",), "__version__"),
    description="Make shell scripts from python functions",
    long_description=read_file(("README.rst",)),
    url="https://github.com/NegativeMjark/simplescript",
    author="Mark Haines",
