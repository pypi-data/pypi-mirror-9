...
struct Dumper {
  ...
  int hsize;
  PyObject *fd;
  struct __pyx_obj_4axon_8_objects_StringWriter *sfd;
  struct __pyx_obj_4axon_7_dumper_SimpleDumper *sdumper;
  int pretty;
  int sorted;
  int crossref;
...
__PYX_EXTERN_C DL_IMPORT(PyObject) *__pyx_v_4axon_7_dumper_c_simple_dumpers;
