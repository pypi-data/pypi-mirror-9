...
static int _cffi_e__point_conversion_form_t(PyObject *lib)
{
  if ((POINT_CONVERSION_COMPRESSED) < 0 || (unsigned long)(POINT_CONVERSION_COMPRESSED) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 ...
                 "point_conversion_form_t", "POINT_CONVERSION_COMPRESSED", buf, "2");
    return -1;
  }
  if ((POINT_CONVERSION_UNCOMPRESSED) < 0 || (unsigned long)(POINT_CONVERSION_UNCOMPRESSED) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "enum %s: %s has the real value %s, not %s",
                 "point_conversion_form_t", "POINT_CONVERSION_UNCOMPRESSED", buf, "4");
    return -1;
  }
  if ((POINT_CONVERSION_HYBRID) < 0 || (unsigned long)(POINT_CONVERSION_HYBRID) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "enum %s: %s has the real value %s, not %s",
                 "point_conversion_form_t", "POINT_CONVERSION_HYBRID", buf, "6");
    return -1;
  }
  return 0;
}
...
static PyObject *
_cffi_f_EC_KEY_new(PyObject *self, PyObject *no_arg)
{
  EC_KEY * result;
...
static PyObject *
_cffi_f_EVP_aes_128_gcm(PyObject *self, PyObject *no_arg)
{
...
static PyObject *
_cffi_f_EVP_aes_192_gcm(PyObject *self, PyObject *no_arg)
{
  EVP_CIPHER const * result;
...
static PyObject *
_cffi_f_EVP_aes_256_gcm(PyObject *self, PyObject *no_arg)
{
  EVP_CIPHER const * result;
...
static PyObject *
_cffi_f_cleanup_ciphers(PyObject *self, PyObject *no_arg)
{
...
static PyObject *
_cffi_f_hmac_ctx_size(PyObject *self, PyObject *no_arg)
{
  size_t result;
...
static PyObject *
_cffi_f_init_ciphers(PyObject *self, PyObject *no_arg)
{
...
PyMODINIT_FUNC
PyInit__cffi__x3b599041x469d9518(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x3b599041x469d9518(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x3b599041x469d9518", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
