#
#
#                 SAMPLE 1 : EXPLAINS THE FUNCTION Trimlet
#
#
...
Hashed = Yrip.Salt.Trimlet("StrOftheTestTobeHashed", 5) # The way is, String to be hashed ; The char length of hashed password you want.
pritn Hashed
...
hashed = Salt.Trimlet("StrOftheTestTobeHashed", 9)
print hashed
#>> cc39b492d

#Example 3

from Yrip.Salt import Trimlet
Hash = Trimlet("StrOftheTestTobeHashed", 7)
print Hash
#>> cc39b49
...
class Yrip_Example(Salt):
	def __init__ (self, a, b):
		...
		self.Hashed = ''
	def doHash(self):
		self.Hashed	= self.Trimlet(self.Hash, self.length)
		return self.Hashed
