...
class PyTest(TestCommand):
    def finalize_options(self):
        ...
        self.test_args = ['test_wsgi_request_id.py']
...
setup(
    name='wsgi-request-id',
    version='0.2',
    url='http://github.com/rhyselsmore/wsgi-request-id',
    author='Rhys Elsmore',
    author_email='me@rhys.io',
    description='Extract yourself some Request IDs.',
    long_description='Extract yourself some Request IDs. See https://github.com/rhyselsmore/wsgi-request-id',
    py_modules=['wsgi_request_id'],
    license=open('LICENSE').read(),
    package_data={'': ['LICENSE']},
    zip_safe=False,
    tests_require=['pytest', 'werkzeug>=0.10.1'],
