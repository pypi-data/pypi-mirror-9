...
Install production Module::
    ...
    >>> modules = Module.find([('name', '=', 'stock_production_location')])
...
Make a production::
    ...
    >>> production.from_location = storage
    >>> production.to_location = output_loc
    >>> production.bom = bom
    >>> production.uom = unit
    ...
    >>> output.state
    u'done'
    >>> output.to_location == output_loc
    True
    >>> input1, input2 = production.inputs
    >>> input1.from_location == storage
    True
    >>> input2.from_location == storage
    True
