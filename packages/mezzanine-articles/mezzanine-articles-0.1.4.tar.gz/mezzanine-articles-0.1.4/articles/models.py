...
class ArticleImage(Orderable):
    ...
    file = FileField(_("File"), max_length=200, format="Image",
        upload_to=upload_to("article.GalleryImage.file", "articles"))
...
class Article(Page, RichText):
    ...
    cover = FileField(
        ...
        upload_to=upload_to("articles.GalleryImage.file", "articles"),
        ...
        if self.zip_import:
            ...
            for name in zip_file.namelist():
                ...
                try:
                    ...
                    saved_path = default_storage.save(path, ContentFile(data))
                self.images.add(ArticleImageImage(file=saved_path))
