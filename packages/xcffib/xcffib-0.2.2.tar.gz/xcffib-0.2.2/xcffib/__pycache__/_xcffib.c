...
static PyObject *
_cffi_f_wrap(PyObject *self, PyObject *arg0)
{
  long x0;
...
static PyObject *
_cffi_f_xcb_screen_next(PyObject *self, PyObject *arg0)
{
  xcb_screen_iterator_t * x0;
  Py_ssize_t datasize;
...
static PyObject *
_cffi_f_xcb_setup_roots_iterator(PyObject *self, PyObject *arg0)
{
  xcb_setup_t const * x0;
  Py_ssize_t datasize;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = xcb_setup_roots_iterator(x0); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS

  return _cffi_from_c_struct((char *)&result, _cffi_type(18));
}
...
static void _cffi_check_struct_xcb_screen_iterator_t(struct xcb_screen_iterator_t *p)
{
  /* only to generate compile-time warnings or errors */
  { xcb_screen_t * *tmp = &p->data; (void)tmp; }
  (void)((p->rem) << 1);
  (void)((p->index) << 1);
}
static PyObject *
_cffi_layout_struct_xcb_screen_iterator_t(PyObject *self, PyObject *noarg)
{
  struct _cffi_aligncheck { char x; struct xcb_screen_iterator_t y; };
  static Py_ssize_t nums[] = {
    sizeof(struct xcb_screen_iterator_t),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct xcb_screen_iterator_t, data),
    sizeof(((struct xcb_screen_iterator_t *)0)->data),
    offsetof(struct xcb_screen_iterator_t, rem),
    sizeof(((struct xcb_screen_iterator_t *)0)->rem),
    offsetof(struct xcb_screen_iterator_t, index),
    sizeof(((struct xcb_screen_iterator_t *)0)->index),
    -1
  };
  return _cffi_get_struct_layout(nums);
  /* the next line is not executed, but compiled */
  _cffi_check_struct_xcb_screen_iterator_t(0);
}
...
static PyMethodDef _cffi_methods[] = {
  ...
  {"xcb_screen_next", _cffi_f_xcb_screen_next, METH_O, NULL},
  {"xcb_send_request", _cffi_f_xcb_send_request, METH_VARARGS, NULL},
  {"xcb_setup_roots_iterator", _cffi_f_xcb_setup_roots_iterator, METH_O, NULL},
  ...
  {"_cffi_layout_struct_xcb_screen_iterator_t", _cffi_layout_struct_xcb_screen_iterator_t, METH_NOARGS, NULL},
