...
try:
    ...
    raise RuntimeError("Cannot import 'cwbrowser', please investigate.")
...
release_info = {}
execfile(os.path.join(os.pardir, os.pardir, "cwbrowser", "info.py"), release_info)
...
htmlhelp_basename = 'rql-upload-doc'
