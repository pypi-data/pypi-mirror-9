#!/usr/bin/python
#Last-modified: 20 Mar 2015 09:38:39 AM
...
import string
import argparse
from ngslib import IO,Utils,FastaFile
...
def argParser():
    ''' Parse arguments. '''
    p=argparse.ArgumentParser(description='Fetch sequences for Bed file from genome file.',epilog='dependency ngslib')
    ...
    p.add_argument("-f","--format",dest="ftype",type=str,metavar="guess",default="guess",help="Format of input file. By default, the program will g uess the format by file extension. Choice can be from 'bed3', 'bedgraph', 'bed','peak','wig', 'sam2bed', 'any' or 'genepred'.")
