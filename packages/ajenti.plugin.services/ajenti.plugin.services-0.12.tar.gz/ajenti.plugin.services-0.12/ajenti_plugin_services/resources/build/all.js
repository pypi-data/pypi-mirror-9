...
// Generated by CoffeeScript 1.8.0
(function() {
  angular.module('ajenti.services').controller('ServiceWidgetController', function($scope, services, notify) {
    ...
    return $scope.runOperation = function(o) {
      ...
      return services.runOperation(svc, o)["catch"](function(e) {
        return notify.error('Service operation failed', e.message);
      });
    };
  });
