"""
Copy of PyPI's code for formatting reStructuredTest descriptions, modified to
output any exception that forces a fallback to plain text.  Used to validate
README.rst files intended for use as package descriptions on PyPI.
