...
class FlaskS3Bower(object):
    """
    The FlaskS3Bower object allows your application to use Flask-S3 and Bower togather.
    Its a merge of two project, FlaskS3 and Flask-Bower

    When initialising a FlaskS3Bower object you may optionally provide your
    ...
    def init_app(self, app):
        ...
        object to Flask-S3-Bower. :meth:`init_app` also takes care of some
        default `settings`_.
