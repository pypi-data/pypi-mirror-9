...
class FileReference(object):
    def __init__(self, fs=None, filename=None, upload_to=None, basename=None, instance=None, name=None):
        self.fs = fs
...
class ImageReference(FileReference):
    def __init__(self, original=None, max_size=None, thumbnail_sizes=None, thumbnails=None, bbox=None, **kwargs):
    ...
    def save(self, file_or_wfs, filename=None, bbox=None):
        ...
        if self.thumbnail_sizes:
            ...
            for size in self.thumbnail_sizes:
                ...
                self.thumbnails[str(size)] = self.fs.save(FileStorage(thumbnail), name(size, 'png'), prefix=prefix)
        return self.filename
...
class ImageField(FileField):
    ...
    def proxy(self, **kwargs):
        return super(ImageField, self).proxy(max_size=self.max_size, thumbnail_sizes=self.thumbnail_sizes, **kwargs)
