...
class ImageFieldTest(MongoEngineTestCase):
    def resource(self):
        return self.filestorage('flask.png', self.app.open_resource('flask.png'))
    ...
    def test_save_file(self):
        ...
        tester = Tester()
        tester.image.save(self.app.open_resource('flask.png'), filename)
        tester.validate()
        ...
        with open(self.storage.path(filename)) as f_stored, self.app.open_resource('flask.png') as f_original:
