...
__all__ = (
    'TEXT', 'DOCUMENTS', 'IMAGES', 'AUDIO', 'DATA', 'SCRIPTS', 'ARCHIVES', 'EXECUTABLES', 'DEFAULTS',
    'ALL', 'All', 'AllExcept',
)
...
SCRIPTS = tuple('js php pl py rb sh bat'.split())
...
def lower_extension(filename):
    """
    This is a helper used by Bucket.save to provide lowercase extensions for
...
class AllExcept(object):
    ...
    to the `Bucket` constructor as `extensions`. You can use any container,
    for example::
