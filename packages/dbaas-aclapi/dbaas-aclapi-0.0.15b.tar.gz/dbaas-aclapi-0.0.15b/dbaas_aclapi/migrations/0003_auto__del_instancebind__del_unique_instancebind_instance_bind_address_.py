...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'InstanceBind', fields ['instance', 'bind_address']
        db.delete_unique(u'dbaas_aclapi_instancebind', ['instance_id', 'bind_address'])

        # Deleting model 'InstanceBind'
        db.delete_table(u'dbaas_aclapi_instancebind')
        ...
        # Adding unique constraint on 'DatabaseInfraInstanceBind', fields ['instance', 'bind_address']
        db.create_unique(u'dbaas_aclapi_databaseinfrainstancebind', ['instance', 'bind_address'])


    def backwards(self, orm):
        # Removing unique constraint on 'DatabaseInfraInstanceBind', fields ['instance', 'bind_address']
        db.delete_unique(u'dbaas_aclapi_databaseinfrainstancebind', ['instance', 'bind_address'])

        # Adding model 'InstanceBind'
        db.create_table(u'dbaas_aclapi_instancebind', (
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'acl_binds', on_delete=models.PROTECT, to=orm['physical.Instance'])),
            ('bind_address', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39)),
            ('bind_status', self.gf('django.db.models.fields.IntegerField')(default=2)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'dbaas_aclapi', ['InstanceBind'])

        # Adding unique constraint on 'InstanceBind', fields ['instance', 'bind_address']
        db.create_unique(u'dbaas_aclapi_instancebind', ['instance_id', 'bind_address'])
    ...
    models = {
        ...
        u'dbaas_aclapi.databaseinfrainstancebind': {
            'Meta': {'unique_together': "((u'instance', u'bind_address'),)", 'object_name': 'DatabaseInfraInstanceBind'},
            'bind_address': ('django.db.models.fields.GenericIPAddressField', [], {'max_length': '39'}),
            'bind_status': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
