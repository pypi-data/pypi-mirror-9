...
class AclClient(object):
    ...
    def destroy_acl(self, payload,):
        ...
        endpoint = "api/ipv{}/acl".format(self.ip_version)
        response = self._make_request(http_verb="DELETE", endpoint=endpoint, payload= payload)
    ...
    def grant_acl_for(self, environment, vlan, payload):
        ...
        response = self._make_request(http_verb="PUT", endpoint=endpoint, payload= json.dumps(payload))
