...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dbaas_aclapi_databasebind', (
            ...
            ('database', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'acl_binds', on_delete=models.PROTECT, to=orm['logical.Database'])),
    ...
    models = {
        ...
        u'dbaas_aclapi.instancebind': {
            'Meta': {'object_name': 'InstanceBind'},
            'bind_address': ('django.db.models.fields.GenericIPAddressField', [], {'max_length': '39'}),
            'bind_status': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'acl_binds'", 'on_delete': 'models.PROTECT', 'to': u"orm['physical.Instance']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'logical.database': {
