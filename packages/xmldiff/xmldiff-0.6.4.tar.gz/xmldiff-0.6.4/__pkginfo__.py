...
__revision__ = '$Id: __pkginfo__.py,v 1.3 2003/10/08 09:35:00 syt Exp $'
...
long_desc = """Xmldiff is a utility for extracting differences between two xml files.
It returns a set of primitives to apply on source tree to obtain the destination
tree.
.
...
author = "Sylvain Th\xc3\xa9nault"
...
try:
    ...
    ext_modules = [Extension('logilab.xmldiff.maplookup',
