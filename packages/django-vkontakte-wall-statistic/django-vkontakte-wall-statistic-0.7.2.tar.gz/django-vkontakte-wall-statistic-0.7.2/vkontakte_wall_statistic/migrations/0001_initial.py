...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PostStatistic'
        db.create_table(u'vkontakte_wall_statistic_poststatistic', (
        ...
        db.send_create_signal(u'vkontakte_wall_statistic', ['PostStatistic'])

        # Adding unique constraint on 'PostStatistic', fields ['post', 'date', 'period']
        db.create_unique(u'vkontakte_wall_statistic_poststatistic', ['post_id', 'date', 'period'])


    def backwards(self, orm):
        # Removing unique constraint on 'PostStatistic', fields ['post', 'date', 'period']
        db.delete_unique(u'vkontakte_wall_statistic_poststatistic', ['post_id', 'date', 'period'])

        # Deleting model 'PostStatistic'
        db.delete_table(u'vkontakte_wall_statistic_poststatistic')
    ...
    models = {
        ...
        u'vkontakte_wall_statistic.poststatistic': {
            ...
            'fetched': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_clicks': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            ...
            'reach_females_age_18': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_females_age_18_21': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_females_age_21_24': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_females_age_24_27': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_females_age_27_30': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_females_age_30_35': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_females_age_35_45': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_females_age_45': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_18': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_18_21': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_21_24': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_24_27': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_27_30': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_30_35': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_35_45': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_males_age_45': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'reach_subscribers': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})
        }
    }
