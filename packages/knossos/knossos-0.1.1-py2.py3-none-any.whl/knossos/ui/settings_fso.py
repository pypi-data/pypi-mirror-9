...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.openLog = QtGui.QPushButton(Form)
        self.openLog.setObjectName("openLog")
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.openLog)
    ...
    def retranslateUi(self, Form):
        ...
        self.openLog.setText(QtGui.QApplication.translate("Form", "Open fs2_open.log", None, QtGui.QApplication.UnicodeUTF8))
