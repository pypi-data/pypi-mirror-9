...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.debugLog = QtGui.QPushButton(Form)
        self.debugLog.setObjectName("debugLog")
        self.formLayout.setWidget(5, QtGui.QFormLayout.FieldRole, self.debugLog)
    ...
    def retranslateUi(self, Form):
        ...
        self.debugLog.setText(QtGui.QApplication.translate("Form", "Open Knossos\' debug log", None, QtGui.QApplication.UnicodeUTF8))
