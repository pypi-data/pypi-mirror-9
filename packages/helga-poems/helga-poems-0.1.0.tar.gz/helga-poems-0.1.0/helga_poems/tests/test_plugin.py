...
from helga.plugins import ResponseNotReady
from helga_poems import plugin as poems


@patch('helga_poems.plugin.get_random_line')
...
@patch('helga_poems.plugin.db')
def test_add(db):
    poems.add(5, 'foobar')
    assert db.haiku.insert.called


@patch('helga_poems.plugin.use')
@patch('helga_poems.plugin.add')
...
@patch('helga_poems.plugin.add')
@patch('helga_poems.plugin.make_poem')
...
def test_make_poem(get_random_line):
    with patch.object(poems, 'fix_repitition', lambda s: s):
        ...
        with patch('helga_poems.plugin.random') as random:
...
@patch('helga_poems.plugin.fix_repitition')
@patch('helga_poems.plugin.get_random_line')
...
@patch('helga_poems.plugin.blame')
...
@patch('helga_poems.plugin.reactor')
...
@patch('helga_poems.plugin.add_use')
...
@patch('helga_poems.plugin.remove')
...
@patch('helga_poems.plugin.claim')
...
@patch('helga_poems.plugin.send_tweet')
