How to contribute to Go Metrics API
====================================

Go Metrics API is an Open Source software project under the BSD
license.  We love contributions!
...
2.  Run the tests, we'll only accept pull requests with passing tests.
    Ensure that the tests run with ``trial go_metrics`` and that
