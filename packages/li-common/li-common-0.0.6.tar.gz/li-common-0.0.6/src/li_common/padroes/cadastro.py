...
class Formulario(entidades.Entidade):
    ...
    """
    def __init__(self):
        self._campos = [atributo for atributo in dir(self) if atributo != 'campos' and atributo != 'nomes_de_campos' and isinstance(getattr(self, atributo), CampoFormulario)]
