...
class ParameterTab(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.l_edit_parameter_name.textChanged.emit(self.l_edit_parameter_name.text())
        ...
        self.l_edit_parameter_caption.textChanged.emit(self.l_edit_parameter_caption.text())
    ...
    def is_ok(self):
        empty = not self.l_edit_parameter_name.text()
...
class AttributeTab(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.l_edit_attribute_name.textChanged.emit(self.l_edit_attribute_name.text())
        ...
        self.l_edit_attribute_caption.textChanged.emit(self.l_edit_attribute_caption.text())
    ...
    def is_ok(self):
        empty = not self.l_edit_attribute_name.text()
