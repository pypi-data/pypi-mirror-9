...
class EyesScreenshot(object):
    ...
    def get_base64(self):
        ...
        if not self._screenshot64:
            screenshot_bytes_stream = BytesIO()
            self._screenshot.write(screenshot_bytes_stream)
            self._screenshot64 = base64.b64encode(screenshot_bytes_stream.getvalue())\
                .decode('UTF-8')
            screenshot_bytes_stream.close()
    ...
    def get_bytes(self):
        ...
        screenshot_bytes_stream = BytesIO()
        self._screenshot.write(screenshot_bytes_stream)
        screenshot_bytes = screenshot_bytes_stream.getvalue()
        screenshot_bytes_stream.close()
