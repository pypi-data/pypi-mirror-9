...
class Partner(Service):
    ...
    def clients(self, partner_id=None, from=None, to=None):
        """
        :rtype : list of Stdclass|list
        """
        return self._callapi("partner/clients", get={"partner_id": partner_id, "from": from, "to": to})

    def partner(self, id, from=None, to=None):
        """
        :rtype : Stdclass
        """
        return self._callapi("partner/partner", get={"id": id, "from": from, "to": to})
