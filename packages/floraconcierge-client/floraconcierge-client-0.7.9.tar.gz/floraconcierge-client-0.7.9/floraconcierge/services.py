...
class Shop(Service):
    ...
    def search_products(self, query, postObject):
        """
        :rtype : list of Product|Collection
        """
        return self._callapi(
...
class Partner(Service):
    ...
    def clients(self, partner_id=None, from1=None, to=None):
        """
        :rtype : list of Stdclass|list
        """
        return self._callapi("partner/clients", get={"partner_id": partner_id, "from": from1, "to": to})

    def partner(self, id, from1=None, to=None):
        """
        :rtype : Stdclass
        """
        return self._callapi("partner/partner", get={"id": id, "from": from1, "to": to})
