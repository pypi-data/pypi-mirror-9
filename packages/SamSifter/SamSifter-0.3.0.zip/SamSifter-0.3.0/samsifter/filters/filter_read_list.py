...
DESC = "Filtering reads by a list of QNAMES given in a tab-separated CSV file."
...
def item():
    ...
    p_read_list = FilterFilepath("read list file",
                                 "tab-separated CSV file with QNAMES in first"
                                 "column",
                                 "--list",
                                 extensions=['csv'],
                                 to_open=True,
                                 required=True,
                                 active=True)
    p_read_list.setDefault("reads.csv")
    item.addParameter(p_read_list)
