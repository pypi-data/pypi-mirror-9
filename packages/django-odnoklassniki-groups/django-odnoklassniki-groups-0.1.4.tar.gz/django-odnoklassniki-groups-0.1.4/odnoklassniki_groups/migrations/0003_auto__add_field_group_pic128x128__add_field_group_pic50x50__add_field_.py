...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.pic128x128'
        db.add_column(u'odnoklassniki_groups_group', 'pic128x128',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Group.pic50x50'
        db.add_column(u'odnoklassniki_groups_group', 'pic50x50',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Group.pic640x480'
        db.add_column(u'odnoklassniki_groups_group', 'pic640x480',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.pic128x128'
        db.delete_column(u'odnoklassniki_groups_group', 'pic128x128')

        # Deleting field 'Group.pic50x50'
        db.delete_column(u'odnoklassniki_groups_group', 'pic50x50')

        # Deleting field 'Group.pic640x480'
        db.delete_column(u'odnoklassniki_groups_group', 'pic640x480')
