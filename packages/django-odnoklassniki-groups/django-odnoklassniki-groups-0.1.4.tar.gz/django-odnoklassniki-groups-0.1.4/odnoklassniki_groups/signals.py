...
def fetch_new_users_members(sender, instance, created, **kwargs):
    if 'odnoklassniki_users' in settings.INSTALLED_APPS and instance.field_name == 'users' and created and \
            instance.content_type.app_label == 'odnoklassniki_groups' and instance.content_type.model == 'group':
