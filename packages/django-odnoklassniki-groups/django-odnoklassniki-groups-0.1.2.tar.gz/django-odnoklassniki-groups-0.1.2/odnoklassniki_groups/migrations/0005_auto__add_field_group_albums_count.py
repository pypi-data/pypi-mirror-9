...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.albums_count'
        db.add_column(u'odnoklassniki_groups_group', 'albums_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.albums_count'
        db.delete_column(u'odnoklassniki_groups_group', 'albums_count')
    ...
    models = {
        ...
        u'odnoklassniki_groups.group': {
            ...
            'albums_count': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'attrs': ('annoying.fields.JSONField', [], {'null': 'True'}),
