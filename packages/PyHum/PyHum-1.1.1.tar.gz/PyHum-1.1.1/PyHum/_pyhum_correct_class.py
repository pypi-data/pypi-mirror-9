...
class humcorrect:
   ...
   def __init__(self, humfile, sonpath, maxW, doplot):
      ...
      try:
         ...
         meta = loadmat(os.path.expanduser("~")+base+'meta.mat')
      meta['maxW'] = maxW

      try:
         savemat(sonpath+base+'meta.mat', meta ,oned_as='row')
      except:
         savemat(os.path.expanduser("~")+base+'meta.mat', meta ,oned_as='row')
      ...
      try:
         ...
         bed = np.squeeze(loadmat(os.path.expanduser("~")+base+'meta.mat')['bed'])
         ft = 1/loadmat(os.path.expanduser("~")+base+'meta.mat')['pix_m'] #np.squeeze(loadmat(sonpath+base+'meta.mat')['ft'])
         dist_m = np.squeeze(loadmat(os.path.expanduser("~")+base+'meta.mat')['dist_m'])
         data_port = np.asarray(np.squeeze(loadmat(os.path.expanduser("~")+base+'.mat')['data_port']),'float16')
         data_star = np.asarray(np.squeeze(loadmat(os.path.expanduser("~")+base+'.mat')['data_star']),'float16')
      ...
      try:
         ...
         savemat(os.path.expanduser("~")+base+'port_la.mat', mdict={'port_mg_la': np.asarray(port_mg_la, 'float16')},oned_as='row')      
      ...
      try:
         ...
         savemat(os.path.expanduser("~")+base+'star_la.mat', mdict={'star_mg_la': np.asarray(star_mg_la, 'float16')},oned_as='row')
      ...
      try:
         ...
         data_dwnhi = np.asarray(np.squeeze(loadmat(os.path.expanduser("~")+base+'.mat')['data_dwnhi']),'float16')
      ...
      if np.size(data_dwnhi)>0:
         ...
         try:
            ...
            savemat(os.path.expanduser("~")+base+'dwnhi_la.mat', mdict={'dwnhi_mg_la': np.asarray(dwnhi_mg_la, 'float16')},oned_as='row')
      ...
      try:
         ...
         data_dwnlow = np.asarray(np.squeeze(loadmat(os.path.expanduser("~")+base+'.mat')['data_dwnlow']),'float16')
      ...
      if np.size(data_dwnlow)>0:
         ...
         try:
            ...
            savemat(os.path.expanduser("~")+base+'dwnlow_la.mat', mdict={'dwnlow_mg_la': np.asarray(dwnlow_mg_la, 'float16')},oned_as='row')
