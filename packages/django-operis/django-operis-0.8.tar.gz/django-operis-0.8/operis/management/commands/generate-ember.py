...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for k,v in model_instances.iteritems():
            ...
            self.logger.log("Creating Base Model for %s",[k],"success")
            self.logger.log("Has Parent is: %s",[v['has_parent']],"debug")
            ...
            if not os.path.isfile(filename) or wipe:
                self.logger.log("Creating Instance Model for %s",[k],"success")
            ...
            self.logger.log("Creating Single Base Controller for %s",[k],"success")
            ...
            if not os.path.isfile(filename) or wipe:
                self.logger.log("Creating Single Instance Controller for %s",[k],"success")
            ...
            self.logger.log("Creating Base Route for %s",[k],"success")
            ...
            if not os.path.isfile(filename) or wipe:
                self.logger.log("Creating Single Instance Route for %s",[k],"success")
            ...
            if not os.path.isfile(filename) or wipe:
                self.logger.log("Creating Single Base Template for %s",[k],"success")
            ...
            if v["plural"]: 
                ...
                self.logger.log("Creating Plural Base Controller for %s",[k],"success")
                ...
                if not os.path.isfile(filename) or wipe:
                    self.logger.log("Creating Plural Instance Controller for %s",[k],"success")
                ...
                self.logger.log("Creating Plural Base Route for %s",[k],"success")
                ...
                if not os.path.isfile(filename) or wipe:
                    self.logger.log("Creating Plural Instance Route for %s",[k],"success")
                ...
                if not os.path.isfile(filename) or wipe:
                    self.logger.log("Creating Plural Template for %s",[k],"success")
