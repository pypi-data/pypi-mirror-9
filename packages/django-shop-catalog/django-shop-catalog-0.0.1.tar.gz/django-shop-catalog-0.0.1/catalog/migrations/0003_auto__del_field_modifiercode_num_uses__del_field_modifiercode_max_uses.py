...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ModifierCode.num_uses'
        db.delete_column(u'catalog_modifier_codes', 'num_uses')

        # Deleting field 'ModifierCode.max_uses'
        db.delete_column(u'catalog_modifier_codes', 'max_uses')

        # Deleting field 'CartModifierCode.is_processed'
        db.delete_column(u'catalog_cart_modifier_codes', 'is_processed')


    def backwards(self, orm):
        # Adding field 'ModifierCode.num_uses'
        db.add_column(u'catalog_modifier_codes', 'num_uses',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ModifierCode.max_uses'
        db.add_column(u'catalog_modifier_codes', 'max_uses',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CartModifierCode.is_processed'
        db.add_column(u'catalog_cart_modifier_codes', 'is_processed',
