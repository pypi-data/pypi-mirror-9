...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalog_related_products', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('base_product', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'related_products', to=orm['catalog.Product'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Product'])),
            ('kind', self.gf('django.db.models.fields.CharField')(default=u'upsell', max_length=255, blank=True)),
            ('bidirectional', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'catalog', ['RelatedProduct'])


    def backwards(self, orm):
        # Deleting model 'RelatedProduct'
        db.delete_table(u'catalog_related_products')
    ...
    models = {
        ...
        u'catalog.relatedproduct': {
            'Meta': {'object_name': 'RelatedProduct', 'db_table': "u'catalog_related_products'"},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.CharField', [], {'default': "u'upsell'", 'max_length': '255', 'blank': 'True'}),
