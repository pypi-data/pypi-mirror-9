...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManufacturerTranslation.description'
        db.add_column(u'catalog_manufacturers_translation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManufacturerTranslation.description'
        db.delete_column(u'catalog_manufacturers_translation', 'description')
