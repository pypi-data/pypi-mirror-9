...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductFlag'
        db.create_table(u'catalog_product_flags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'flags', to=orm['catalog.Product'])),
            ('flag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Flag'])),
            ('is_true', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'catalog', ['ProductFlag'])

        # Adding unique constraint on 'ProductFlag', fields ['product', 'flag']
        db.create_unique(u'catalog_product_flags', ['product_id', 'flag_id'])

        # Adding model 'Flag'
        db.create_table(u'catalog_flags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=128)),
        ))
        db.send_create_signal(u'catalog', ['Flag'])

        # Adding model 'FlagTranslation'
        db.create_table(u'catalog_flags_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['catalog.Flag'])),
        ))
        db.send_create_signal(u'catalog', ['FlagTranslation'])

        # Adding unique constraint on 'FlagTranslation', fields ['language_code', 'master']
        db.create_unique(u'catalog_flags_translation', ['language_code', 'master_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FlagTranslation', fields ['language_code', 'master']
        db.delete_unique(u'catalog_flags_translation', ['language_code', 'master_id'])

        # Removing unique constraint on 'ProductFlag', fields ['product', 'flag']
        db.delete_unique(u'catalog_product_flags', ['product_id', 'flag_id'])

        # Deleting model 'ProductFlag'
        db.delete_table(u'catalog_product_flags')

        # Deleting model 'Flag'
        db.delete_table(u'catalog_flags')

        # Deleting model 'FlagTranslation'
        db.delete_table(u'catalog_flags_translation')
