...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandTranslation.description'
        db.add_column(u'catalog_brands_translation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CategoryTranslation.description'
        db.add_column(u'catalog_categories_translation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ProductTranslation.description'
        db.add_column(u'catalog_products_translation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandTranslation.description'
        db.delete_column(u'catalog_brands_translation', 'description')

        # Deleting field 'CategoryTranslation.description'
        db.delete_column(u'catalog_categories_translation', 'description')

        # Deleting field 'ProductTranslation.description'
        db.delete_column(u'catalog_products_translation', 'description')
