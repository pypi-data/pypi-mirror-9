...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RelatedProduct.bidirectional'
        db.delete_column(u'catalog_related_products', 'bidirectional')


        # Changing field 'RelatedProduct.kind'
        db.alter_column(u'catalog_related_products', 'kind', self.gf('catalog.fields.UnderscoreField')(max_length=255))
        # Adding index on 'RelatedProduct', fields ['kind']
        db.create_index(u'catalog_related_products', ['kind'])

        # Adding unique constraint on 'RelatedProduct', fields ['base_product', 'product', 'kind']
        db.create_unique(u'catalog_related_products', ['base_product_id', 'product_id', 'kind'])


    def backwards(self, orm):
        # Removing unique constraint on 'RelatedProduct', fields ['base_product', 'product', 'kind']
        db.delete_unique(u'catalog_related_products', ['base_product_id', 'product_id', 'kind'])

        # Removing index on 'RelatedProduct', fields ['kind']
        db.delete_index(u'catalog_related_products', ['kind'])

        # Adding field 'RelatedProduct.bidirectional'
        db.add_column(u'catalog_related_products', 'bidirectional',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'RelatedProduct.kind'
        db.alter_column(u'catalog_related_products', 'kind', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'catalog.brand': {
            ...
            'body': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'brand_body_set'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
        ...
        u'catalog.category': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'body': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'category_body_set'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'featured_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'catalog.manufacturer': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'body': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'manufacturer_body_set'", 'null': 'True', 'to': "orm['cms.Placeholder']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'featured_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'catalog.relatedproduct': {
            'Meta': {'unique_together': "((u'base_product', u'product', u'kind'),)", 'object_name': 'RelatedProduct', 'db_table': "u'catalog_related_products'"},
            'base_product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'related_products'", 'to': u"orm['catalog.Product']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('catalog.fields.UnderscoreField', [], {'default': "u'upsell'", 'max_length': '255'}),
