...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartModifierCode.can_be_deleted'
        db.delete_column(u'catalog_cart_modifier_codes', 'can_be_deleted')
    ...
    def backwards(self, orm):
        # Adding field 'CartModifierCode.can_be_deleted'
        db.add_column(u'catalog_cart_modifier_codes', 'can_be_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
