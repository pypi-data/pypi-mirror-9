...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalog_categories', 'featured_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.body'
        db.add_column(u'catalog_categories', 'body',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'category_body_set', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'Manufacturer.featured_image'
        db.add_column(u'catalog_manufacturers', 'featured_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Manufacturer.body'
        db.add_column(u'catalog_manufacturers', 'body',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'manufacturer_body_set', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'Brand.featured_image'
        db.add_column(u'catalog_brands', 'featured_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Brand.body'
        db.add_column(u'catalog_brands', 'body',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'brand_body_set', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.featured_image'
        db.delete_column(u'catalog_categories', 'featured_image_id')

        # Deleting field 'Category.body'
        db.delete_column(u'catalog_categories', 'body_id')

        # Deleting field 'Manufacturer.featured_image'
        db.delete_column(u'catalog_manufacturers', 'featured_image_id')

        # Deleting field 'Manufacturer.body'
        db.delete_column(u'catalog_manufacturers', 'body_id')

        # Deleting field 'Brand.featured_image'
        db.delete_column(u'catalog_brands', 'featured_image_id')

        # Deleting field 'Brand.body'
        db.delete_column(u'catalog_brands', 'body_id')
