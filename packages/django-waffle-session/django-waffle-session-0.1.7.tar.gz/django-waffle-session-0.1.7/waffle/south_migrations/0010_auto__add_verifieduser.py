...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VerifiedUser'
        db.create_table(u'waffle_verifieduser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waffle.Flag'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'waffle', ['VerifiedUser'])


    def backwards(self, orm):
        # Deleting model 'VerifiedUser'
        db.delete_table(u'waffle_verifieduser')
    ...
    models = {
        ...
        u'waffle.verifieduser': {
            'Meta': {'object_name': 'VerifiedUser'},
            'feature': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['waffle.Flag']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
