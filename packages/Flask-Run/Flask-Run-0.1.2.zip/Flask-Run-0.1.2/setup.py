...
__doc__ = re.search('(["\']{3})(.*?)\\1', __src__, re.M).group(2).strip()
__version__ = re.search('__version__\s*=\s*(["\'])(.*?)\\1', __src__).group(2).strip()
...
properties = dict(
    name = 'Flask-Run',
    version = __version__,
    url = 'https://github.com/salsita/flask-run',
    download_url = 'https://github.com/salsita/flask-run/tarball/v{}'.format( __version__),
