...
Message = cara.Struct(name="Message", id=0x91b79f1f808db032, qualname="Message.rpc.capnp")
Bootstrap = cara.Struct(name="Bootstrap", id=0xe94ccf8031176ec4, qualname="Bootstrap.rpc.capnp")
Call = cara.Struct(name="Call", id=0x836a53ce789d4cd4, qualname="Call.rpc.capnp")
Return = cara.Struct(name="Return", id=0x9e19b28d3db3573a, qualname="Return.rpc.capnp")
Finish = cara.Struct(name="Finish", id=0xd37d2eb2c2f80e63, qualname="Finish.rpc.capnp")
Resolve = cara.Struct(name="Resolve", id=0xbbc29655fa89086e, qualname="Resolve.rpc.capnp")
Release = cara.Struct(name="Release", id=0xad1a6c0d7dd07497, qualname="Release.rpc.capnp")
Disembargo = cara.Struct(name="Disembargo", id=0xf964368b0fbd3711, qualname="Disembargo.rpc.capnp")
Provide = cara.Struct(name="Provide", id=0x9c6a046bfbc1ac5a, qualname="Provide.rpc.capnp")
Accept = cara.Struct(name="Accept", id=0xd4c9b56290554016, qualname="Accept.rpc.capnp")
Join = cara.Struct(name="Join", id=0xfbe1980490e001af, qualname="Join.rpc.capnp")
MessageTarget = cara.Struct(name="MessageTarget", id=0x95bc14545813fbc1, qualname="MessageTarget.rpc.capnp")
Payload = cara.Struct(name="Payload", id=0x9a0e61223d96743b, qualname="Payload.rpc.capnp")
CapDescriptor = cara.Struct(name="CapDescriptor", id=0x8523ddc40b86b8b0, qualname="CapDescriptor.rpc.capnp")
PromisedAnswer = cara.Struct(name="PromisedAnswer", id=0xd800b1d6cd6f1ca0, qualname="PromisedAnswer.rpc.capnp")
PromisedAnswer.Op = cara.Struct(name="Op", id=0xf316944415569081, qualname="PromisedAnswer.Op.rpc.capnp")
ThirdPartyCapDescriptor = cara.Struct(name="ThirdPartyCapDescriptor", id=0xd37007fde1f0027d, qualname="ThirdPartyCapDescriptor.rpc.capnp")
Exception = cara.Struct(name="Exception", id=0xd625b7063acf691a, qualname="Exception.rpc.capnp")
