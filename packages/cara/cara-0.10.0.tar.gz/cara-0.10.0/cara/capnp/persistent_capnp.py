...
Persistent = cara.TemplatedInterface(name="Persistent", id=0xc8cb212fcd9f5691, templates=["SturdyRef"], qualname="Persistent.persistent.capnp")
Persistent.SaveParams = cara.Struct(name="SaveParams", id=0xf76fba59183073a5, qualname="Persistent.SaveParams.persistent.capnp")
Persistent.SaveResults = cara.Struct(name="SaveResults", id=0xb76848c18c40efbf, qualname="Persistent.SaveResults.persistent.capnp")
RealmGateway = cara.TemplatedInterface(name="RealmGateway", id=0x84ff286cd00a3ed4, templates=["InternalRef", "ExternalRef"], qualname="RealmGateway.persistent.capnp")
