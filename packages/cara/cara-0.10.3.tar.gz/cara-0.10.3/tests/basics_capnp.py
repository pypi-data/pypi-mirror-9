...
from cara.capnp import cara_capnp
...
Basic = cara.Struct(name="Basic", id=0xf950b63201d11192)
...
Basic.FinishDeclaration(
    fields=[cara.Field(id=0, name="field", type=cara.Int32), cara.Field(id=1, name="type", type=schema_capnp.Type), cara.Field(id=2, name="list", type=cara.List(Basic)), cara.Field(id=3, name="ints", type=cara.List(cara.Int32)), cara.Field(id=4, name="nested", type=Basic)], annotations=[cara_capnp.registerGlobally(cara.Void())])
