...
Node = cara.Struct(name="Node", id=0xe682ab4cf923a417, qualname="Node.schema.capnp")
Node.Parameter = cara.Struct(name="Parameter", id=0xb9521bccf10fa3b1, qualname="Node.Parameter.schema.capnp")
Node.NestedNode = cara.Struct(name="NestedNode", id=0xdebf55bbfa0fc242, qualname="Node.NestedNode.schema.capnp")
Field = cara.Struct(name="Field", id=0x9aad50a41f4af45f, qualname="Field.schema.capnp")
Field.noDiscriminant = cara.Const(name="noDiscriminant", id=0x97b14cbe7cfec712, qualname="Field.noDiscriminant.schema.capnp")
Enumerant = cara.Struct(name="Enumerant", id=0x978a7cebdc549a4d, qualname="Enumerant.schema.capnp")
Superclass = cara.Struct(name="Superclass", id=0xa9962a9ed0a4d7f8, qualname="Superclass.schema.capnp")
Method = cara.Struct(name="Method", id=0x9500cce23b334d80, qualname="Method.schema.capnp")
Type = cara.Struct(name="Type", id=0xd07378ede1f9cc60, qualname="Type.schema.capnp")
Brand = cara.Struct(name="Brand", id=0x903455f06065422b, qualname="Brand.schema.capnp")
Brand.Scope = cara.Struct(name="Scope", id=0xabd73485a9636bc9, qualname="Brand.Scope.schema.capnp")
Brand.Binding = cara.Struct(name="Binding", id=0xc863cd16969ee7fc, qualname="Brand.Binding.schema.capnp")
Value = cara.Struct(name="Value", id=0xce23dcd2d7b00c9b, qualname="Value.schema.capnp")
Annotation = cara.Struct(name="Annotation", id=0xf1c8950dab257542, qualname="Annotation.schema.capnp")
...
CodeGeneratorRequest = cara.Struct(name="CodeGeneratorRequest", id=0xbfc546f6210ad7ce, qualname="CodeGeneratorRequest.schema.capnp")
CodeGeneratorRequest.RequestedFile = cara.Struct(name="RequestedFile", id=0xcfea0eb02e810062, qualname="CodeGeneratorRequest.RequestedFile.schema.capnp")
CodeGeneratorRequest.RequestedFile.Import = cara.Struct(name="Import", id=0xae504193122357e5, qualname="CodeGeneratorRequest.RequestedFile.Import.schema.capnp")
