...
def main(pitch, fixedExit, hkl, stripe, eMinRays, eMaxRays, eTune, vfmR,
    ...
    beamLine = BalderBL.build_beamline(100000, hkl, stripe, eMinRays, eMaxRays)
    BalderBL.align_beamline(beamLine, pitch=pitch, energy=eTune,
                            fixedExit=fixedExit, vfmR=vfmR)
    suffix = ''
...
#    dz = max(0.1, beamLine.spotSizeH*0.55)
    ...
    xrtr.run_ray_tracing(plots, repeats=1, beamLine=beamLine, processes='h')
