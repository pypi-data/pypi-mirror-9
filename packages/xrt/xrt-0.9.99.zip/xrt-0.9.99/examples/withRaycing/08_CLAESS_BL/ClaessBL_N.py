...
def build_beamline(nrays=raycing.nrays, eMinRays=None, eMaxRays=None):
...
#    beamFurtherDown = beamSource
    ...
    outDict = {'beamSource': beamSource,
               ...
               'beamFSM4': beamFSM4, 'beamPSFrontLocal': beamPSFrontLocal,
...
#    beamLine.vfm.yaw = 50e-6
    ...
    beamLine.eh100To40Flange.set_z(heightVFM)
