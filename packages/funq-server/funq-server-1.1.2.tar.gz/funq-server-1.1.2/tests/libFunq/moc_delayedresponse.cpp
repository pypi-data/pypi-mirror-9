...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DelayedResponse_t, stringdata) + ofs \
...
void DelayedResponse::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DelayedResponse::*_t)(const QtJson::JsonObject & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DelayedResponse::aboutToWriteResponse)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DelayedResponse::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DelayedResponse.data,
      qt_meta_data_DelayedResponse,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DelayedResponse.stringdata))
        return static_cast<void*>(const_cast< DelayedResponse*>(this));
