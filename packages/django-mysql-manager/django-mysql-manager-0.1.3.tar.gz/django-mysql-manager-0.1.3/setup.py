...
from mysql_manager import get_version
...
if __name__=='__main__':
    setup(
        ...
        url = 'http://www.codetrax.org/projects/django-mysql-manager',
        description = 'django-mysql-manager is a Django based management interface for MySQL users and databases.',
        long_description = read('README'),
        download_url = 'https://source.codetrax.org/hgroot/django-mysql-manager',
        platforms=['any'],
        classifiers = [
        ...
        packages = [
            'mysql_manager',
            #'mysql_manager.templatetags',
            #'mysql_manager.management',
            #'mysql_manager.management.commands',
        ],
