...
setup(
    name = 'qdudomportal',
    version = '0.0.2',
    description = 'Qingdao University Dormitory Portal',
    long_description = readme + history,
    author = 'Cole Smith',
    author_email = 'uniquecolesmith@gmail.com',
    url = '',
    packages = ['qdudomportal'],
    package_dir = {"qdudomportal": "src"},
    include_package_data = True,
    install_requires = ['requests', 'pillow', 'pytesseract'],
    license = "Apache 2.0",
    zip_safe = False,
    ...
    entry_points = {"console_scripts": ["qdudomportal = qdudomportal:main"]},
