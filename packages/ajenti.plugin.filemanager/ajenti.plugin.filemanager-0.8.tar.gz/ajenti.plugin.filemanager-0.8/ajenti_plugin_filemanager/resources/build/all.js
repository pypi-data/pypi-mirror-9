...
// Generated by CoffeeScript 1.8.0
(function() {
  angular.module('ajenti.filemanager').controller('FileManagerIndexController', function($scope, $routeParams, $location, $localStorage, $timeout, notify, filesystem, pageTitle, urlPrefix, tasks, $upload) {
    var uploadCallback;
