...
class CompysitionGreenlet(Greenlet):
    """
    ...
    Additional parameters:
        - restart_desired (bool):   (Default: True) This flag is designed to be used as a signifier to a linked exception callback
    ...
    def __init__(self, run=None, restart_desired=True, *args, **kwargs):
        self.run_target = run
        self.run_target_args = args
        self.run_target_kwargs = kwargs
        self.restart_desired = restart_desired
