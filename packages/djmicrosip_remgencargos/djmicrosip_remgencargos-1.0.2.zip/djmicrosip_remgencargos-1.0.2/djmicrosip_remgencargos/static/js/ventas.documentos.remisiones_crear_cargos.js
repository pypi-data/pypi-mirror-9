$(document).ready(function() {
	$("#id_cliente_text").addClass("form-control");
	...
	function generar_cargos(){
		submint_button =  this;
		submint_button.disabled=true;
		submint_button.textContent ="Generando cargos...";
		var ids = '';
		...
		$.ajax({
			data: {'ids':ids},
			url:'/remisiones_cxc/ventas/generar_cargos/',
			type : 'get',
			success: function(data){
				$("#generar_cargos").text("Generar cargos");
				...
				submint_button.textContent ="Generar cargos";
				submint_button.disabled = false;
