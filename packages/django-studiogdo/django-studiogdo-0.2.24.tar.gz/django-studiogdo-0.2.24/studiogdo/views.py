...
class SimpleTinyMCEView(TemplateView):
    template_name = 'studiogdo/pip/page.html'
    
    
    def dispatch(self, request, *args, **kwargs):
        self.get_file_data()
        return super(SimpleTinyMCEView, self).dispatch(request, *args, **kwargs)
    ...
    def get_page(self):
        return self.kwargs.get('page', None)