...
def main():
    # Create main parser
    parser = argparse.ArgumentParser(description='Tool for easy deploying django-projects to Amazon AWS')
    ...
    if hasattr(args, 'command'):
        ...
        interface.print_task(inspect.getdoc(args.command))

        # Execute command
        args.command()
        interface.exit_success()
