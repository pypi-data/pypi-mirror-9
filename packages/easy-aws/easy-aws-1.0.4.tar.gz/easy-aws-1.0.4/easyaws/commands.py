...
class Commands:
    ...
    class Project:
        """
        Deploying/undeploying django project
        """
    ...
    class Renv:
        ...
        def create(cls):
            """
            Create and setup EC2-instance for remote environment in PyCharm
            """

            # Create security group
            security_group = aws.helpers.get_or_create_security_group('remote-environment', [22])
            ...
            interface.exit_success('Now you can connect to instance:\n'
                                   'ssh -i {} ubuntu@{}'.format(key_path, instance.public_dns_name))
