...
class Config(object):
    def __init__(self, config_paths=None, debug=False):
        ...
        self.home = os.path.abspath(os.path.dirname(config_paths and config_paths[0] or '.'))
    ...
    def serializer(self):
        ...
        assert hasattr(module, 'loads') and hasattr(module, 'dumps'), 'Serializer should have loads and dumps methods'
