...
class IMongoUpdateMixin(zope.interface.Interface):
    ...
    def update(data, safe=True, raiseErrors=False):
        ...
        If raiseErrors is set to True, an error get raised. You can also set
        safe to False if you don't care about MongoDB processing errors. If you
        use safe=True then we will get sure that the update was Ok in MongoDB.
        But this also means that a blocking request get used.
