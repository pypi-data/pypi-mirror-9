...
Prog:	Stringen v1.1 (Python 3.3.0)
...
II.	Instructions
---------------------------------------------------------------------------------------------------------------------------
I used Python 3.3.0. I tested this program with Python 2.7.5 and received errors. 
...
2.	Stat: time spent generating passwords and passwords per second.
3.	Estimated output file size.
4.	Progress indicator.
5.	Stat: length of longest password generated.


V.	Version history
---------------------------------------------------------------------------------------------------------------------------
1.1	
Added prompt for number of lines to use from 'in.txt'
Added prompt for 'are you sure?'
