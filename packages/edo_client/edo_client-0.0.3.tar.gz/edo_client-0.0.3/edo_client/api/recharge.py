...
class RechargeApi(BaseApi):
    ...
    def new_code(self, amount, deadline, creator, description, secret, account_name=''):
        ...
        signcode = md5.new(amount + deadline + creator + description + timestamp + secret).hexdigest()
