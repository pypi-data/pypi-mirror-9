...
static PyObject *
_cffi_f__cmph_setup_py_logger(PyObject *self, PyObject *arg0)
{
  void(* x0)(int, char *);

  x0 = (void(*)(int, char *))_cffi_to_c_pointer(arg0, _cffi_type(0));
  if (x0 == (void(*)(int, char *))NULL && PyErr_Occurred())
    return NULL;

  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { _cmph_setup_py_logger(x0); }
  _cffi_save_errno();
...
_cffi_f_cmph_config_set_algo(PyObject *self, PyObject *args)
{
  ...
  if (_cffi_to_c((char *)&x1, _cffi_type(4), arg1) < 0)
    return NULL;
...
static PyObject *
_cffi_f_cmph_io_function_adapter(PyObject *self, PyObject *args)
{
  char *(* x0)(void);
  void(* x1)(void);
  void(* x2)(void);
  unsigned int(* x3)(void);
  unsigned int x4;
  cmph_io_adapter_t * result;
  PyObject *arg0;
  PyObject *arg1;
  ...
  if (!PyArg_ParseTuple(args, "OOOOO:cmph_io_function_adapter", &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;

  x0 = (char *(*)(void))_cffi_to_c_pointer(arg0, _cffi_type(10));
  if (x0 == (char *(*)(void))NULL && PyErr_Occurred())
    return NULL;
  ...
  x2 = (void(*)(void))_cffi_to_c_pointer(arg2, _cffi_type(11));
  if (x2 == (void(*)(void))NULL && PyErr_Occurred())
    return NULL;

  x3 = (unsigned int(*)(void))_cffi_to_c_pointer(arg3, _cffi_type(12));
  if (x3 == (unsigned int(*)(void))NULL && PyErr_Occurred())
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = cmph_io_function_adapter(x0, x1, x2, x3, x4); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyObject *
_cffi_f_cmph_io_function_adapter_destroy(PyObject *self, PyObject *arg0)
{
  cmph_io_adapter_t * x0;
  Py_ssize_t datasize;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { cmph_io_function_adapter_destroy(x0); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyMethodDef _cffi_methods[] = {
  {"_cmph_setup_py_logger", _cffi_f__cmph_setup_py_logger, METH_O, NULL},
  ...
  {"cmph_io_function_adapter", _cffi_f_cmph_io_function_adapter, METH_VARARGS, NULL},
  {"cmph_io_function_adapter_destroy", _cffi_f_cmph_io_function_adapter_destroy, METH_O, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__xd5b17556xa88ce482(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__xd5b17556xa88ce482(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__xd5b17556xa88ce482", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
