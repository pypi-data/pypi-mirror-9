...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'carburetion_tank.content'
        db.add_column('main_carburetion_tank', 'content',
                      self.gf('django.db.models.fields.CharField')(default='G', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'carburetion_tank.content'
