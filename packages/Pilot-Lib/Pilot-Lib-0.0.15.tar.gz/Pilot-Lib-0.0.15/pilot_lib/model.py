...
def user_mixin(db):
    ...
    class UserMixin(object):
        ...
        signin_method = db.Column(db.String(250))
...
def user_model(db):
    ...
    class User(UserMixin, db.Model):
        ...
        @classmethod
        def social_login(cls, provider, provider_user_id=None,
            ...
            usl = UserSocialLogin
            socialuser = usl.all()\
                .filter(usl.provider == provider)\
                .filter(usl.provider_user_id == provider_user_id)\
                .first()
            if socialuser:
    ...
    class UserSocialLogin(db.Model):
        ...
        user = db.relationship(User, backref="social_logins")
