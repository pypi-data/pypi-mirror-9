...
# Test that an abstract class and an abstract subclass does not get instanciated
code1="""
CherryClass Class1 abstract:
CherryClass Class2(Class1) abstract:
"""
errorCodeList=["class1=Class1()", "class2=Class2()"]

def test(infoMap, failedList, skipped):
    print "    Testing abstract class non-instantation...",
    testCode.checkNotInSourceFile("Abstract class non-instantation", infoMap, code1, "", errorCodeList, failedList)
