...
class FacebookAPIClient(object):
    ...
    object_map = {
        u'FacebookWcaAdGroup': AdGroup,
        u'FacebookWcaAdSet': AdSet,
        u'FacebookWcaCampaign': AdCampaign,
        u'FacebookRtbAdGroup': AdGroup,
        u'FacebookRtbAdSet': AdSet,
        u'FacebookRtbCampaign': AdCampaign,
        u'FacebookCustomAudience': CustomAudience,
        u'FacebookOffsitePixel': AdConversionPixel,
        u'FacebookImage': AdImage
    }
    ...
    def local_object_to_remote_object(self, local_object):
        ...
        remote_object = self.object_map.get(local_object.__class__.__name__)(parent_id=account_id)
    ...
    def _execute(self, method, local_object, batch=None):
        ...
        success = local_object.get_success_callback(method, remote_object=remote_object)
        failure = local_object.failure_callback
