...
def multitest(path, options, query, lemmatise = False, 
    ...
    def interrogate_subcorpus((index, d)):
        r = [d, [11, d*12], [11, d*2], [11, d*17], [u'Total', 44 * d]]
        return r
    ...
    for index, d in enumerate(sorted_dirs):
        print index, d
        results_list.append(job_server.submit(interrogate_subcorpus, ((index, d),)))
    
    allwords_list = [r[1] for r in results_list]
