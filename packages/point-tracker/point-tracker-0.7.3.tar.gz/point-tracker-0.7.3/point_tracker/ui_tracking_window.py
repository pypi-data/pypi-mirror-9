...
# Form implementation generated from reading ui file 'tracking_window.ui'
#
...
class Ui_TrackingWindow(object):
    def setupUi(self, TrackingWindow):
        ...
        self.hboxlayout1.addWidget(self.previousState)
        ...
        self.vboxlayout2.addWidget(self.copyToCurrent)
        spacerItem1 = QtGui.QSpacerItem(80, 21, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout2.addItem(spacerItem1)
        self.linkViews = QtGui.QPushButton(self.centralwidget)
        self.linkViews.setText(_fromUtf8(""))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/link_broken.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/link.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.linkViews.setIcon(icon1)
        self.linkViews.setIconSize(QtCore.QSize(64, 24))
        self.linkViews.setCheckable(True)
        self.linkViews.setObjectName(_fromUtf8("linkViews"))
        self.vboxlayout2.addWidget(self.linkViews)
        ...
        self.vboxlayout2.addWidget(self.copyToPrevious)
        self.vboxlayout1.addLayout(self.vboxlayout2)
        spacerItem3 = QtGui.QSpacerItem(20, 81, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.hboxlayout2.addWidget(self.currentState)
        ...
        self.vboxlayout3.addWidget(self.currentData)
    ...
    def retranslateUi(self, TrackingWindow):
        ...
        self.actionNew_data_file.setShortcut(_translate("TrackingWindow", "Ctrl+N", None))
...
from point_tracker.trackingview import TrackingView
