...
from onyx.core import (Structure, CurveIntersect,
                       GraphNodeVt, ChildrenIterator, EvalBlock, SetDiddle)
    ...
    def Deltas(self, graph):
        ...
        for kid in ChildrenIterator(self, "MktValUSD", "Spot"):
            try:
                ...
                # --- skip assets that don't expose Denominated value type
                continue
            spot = graph(kid, "Spot")
            fx = graph(cross, "Spot")
            shift = 0.01*spot
    ...
    def GrossExposure(self, graph):
        ...
        for sec, qty in graph(self, "Deltas").items():
            try:
                ...
                # --- skip assets that don't expose SpotForRisk value type
                continue
    ...
    def Betas(self, graph):
        ...
        for kid in ChildrenIterator(self, "MktValUSD", "Spot"):
            try:
                ...
                # --- skip assets that don't expose PricesForRisk value type
                continue
