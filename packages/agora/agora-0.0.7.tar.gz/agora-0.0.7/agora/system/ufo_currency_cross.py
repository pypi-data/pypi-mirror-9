...
from onyx.core import (Curve, UfoBase, ReferenceField, StringField,
...
class CurrencyCross(UfoBase):
    ...
    def Last(self, graph):
        """
        Return the most recent close value irrespective of MktDataDate.
        """
...
def prepare_for_test():
    from onyx.core import SetDiddle
