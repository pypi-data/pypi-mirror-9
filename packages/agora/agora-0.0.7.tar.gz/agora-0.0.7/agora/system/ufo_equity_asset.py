...
from onyx.core import (Date, Curve, CalcTerm, Interpolate,
                       Transaction, DelObj, GetVal, TsDbQuery, TsDbGetCurve,
                       StringField, DictField, GraphNodeVt)
...
class EquityAsset(Asset):
    ...
    def __post_init__(self):
        ...
        self.Name = "EQ {0:s} {1:s}".format(self.Symbol, exchange_code)
    ...
    def Last(self, graph):
        """
        Return the most recent close value irrespective of MktDataDate in the
        Denominated currency.
        """
        last = graph(graph(self, "Marks"), "PrcByDate", Date.today(), False)
        return last*graph(self, "Multiplier")
