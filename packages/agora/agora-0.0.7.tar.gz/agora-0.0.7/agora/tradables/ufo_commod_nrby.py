...
from onyx.core import (Curve, CurveUnion, DateRange, Date2LYY,
                       GraphNodeVt, GetVal,
                       IntField, DateField, SelectField, ReferenceField)

from agora.corelibs.date_functions import DateOffset
from agora.corelibs.tradable_api import NamedByInference, HashInstreams
...
class CommodNrby(NamedByInference):
    ...
    def AverageValue(self, graph):
        return graph(self, "DataCurve").values.mean()
