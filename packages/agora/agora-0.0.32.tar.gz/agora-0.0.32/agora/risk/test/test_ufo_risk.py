...
class UnitTest(unittest.TestCase):
    ...
    def test_Deltas(self):
        ...
        self.assertEqual(GetVal(self.book, "Deltas"), ref_deltas)

    def test_Exposures(self):
        self.assertEqual(GetVal(self.book, "GrossExposure"), 18000.0)
        self.assertEqual(GetVal(self.book, "NetExposure"), -18000.0)
