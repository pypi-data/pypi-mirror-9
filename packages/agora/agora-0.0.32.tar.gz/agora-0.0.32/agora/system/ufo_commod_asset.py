...
from.agora.system.ufo_asset import WithAssetInstreams
...
###############################################################################
class CommodAsset(WithAssetInstreams):
    """
        ...
        for cnt in contracts:
            if cnt not in self.Contracts:
                info = {attr: getattr(self, attr)
                        for attr in super()._json_fields}
                info.update({
                ...
                try:
                    ...
                    if obj != cnt_obj:
                        raise RuntimeError("Instreams of existing contract "
