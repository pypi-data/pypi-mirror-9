...
from onyx.core import GetVal, ChildrenSet
...
class UnitTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.securities = ufo_equity_cash.prepare_for_test()

    def setUp(self):
        self.sec = self.securities[0]

    def test_MktVal(self):
        self.assertAlmostEqual(GetVal(self.sec, "MktVal"), 9.0, 8)

    def test_MktValUSD(self):
        self.assertAlmostEqual(GetVal(self.sec, "MktValUSD"), 13.5, 8)
