...
__all__ = ["WithAssetInstreams", "Asset"]


###############################################################################
class WithAssetInstreams(UfoBase):
    """
    This class is used to expose Instreams that are common to all assets or to
    classes that act as parents for assets (such as CommodAsset).
    """
    Symbol = StringField()
...
###############################################################################
class Asset(WithAssetInstreams):
    """
