...
from.agora.system.ufo_CommodAsset import CommodAsset
...
class CommodCnt(Asset):
    ...
    def Market(self, graph):
        # --- Market is inherited from that of the parent CommodAsset
        return graph(graph(self, "CommodAsset"), "Market")

    # -------------------------------------------------------------------------
    @GraphNodeVt("Property")
    def Symbol(self, graph):
        # --- Symbol is inherited from that of the parent CommodAsset
        return graph(graph(self, "CommodAsset"), "Symbol")

    # -------------------------------------------------------------------------
    @GraphNodeVt("Property")
    def CntType(self, graph):
        # --- CntType is inherited from that of the parent CommodAsset
        return graph(graph(self, "CommodAsset"), "CntType")
