...
from onyx.core import (Date, CalcTerm,
                       SelectField, ReferenceField, DictField,
                       GetVal, GraphNodeVt, EvalBlock)

from agora.corelibs.ufo_functions import MktIndirectionFactory
from agrora.system.ufo_archivable import Archivable
from agora.quantlib.black_scholes import implied_vol
...
class EquityVolMatrix(Archivable):
    ...
    def __post_init__(self):
        ...
        self.Name = ("EQ VOLMAT {0:s} "
                     "{1:s}").format(self.Asset.Symbol, exch_code)
    ...
    def generate_vol_marks(self, pd, price_marks):
        ...
        with EvalBlock() as eb:
            eb.set_diddle("Database", "MktDataDate", pd)
