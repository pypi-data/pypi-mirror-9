...
from onyx.core import (Structure, GraphNodeVt, GetVal, SetVal,
...
class EquityFloatingLeg(NamedByInference):
    ...
    def ImpliedName(self):
        ...
        return "EqFloating {0:6s} {1:2s}".format(sym, code)
