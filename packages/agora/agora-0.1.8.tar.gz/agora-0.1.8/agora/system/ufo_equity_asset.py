...
from onyx.core import (Date, Curve, Knot, HlocvCurve, CalcTerm, Interpolate,
                       Transaction, DelObj, ObjNotFound, GetVal,
                       TsDbQuery, TsDbGetCurve, TsNotFound,
                       StringField, DictField, ReferenceField, GCurveField,
                       GraphNodeVt)
...
# --- datatype used by the DividendSchedule (a GCurve of namedtuples)
FUTDIV = collections.namedtuple("FUTDIV", "PaymentDate, NetDividend")

# --- map drop-down values to value types (used by edit screens)
CRV_CHOICES = {
    "Adjusted": "GetCurve",
    "Marks": "GetMarks",
