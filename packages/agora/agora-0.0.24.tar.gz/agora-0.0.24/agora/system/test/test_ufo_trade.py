...
class UnitTest(unittest.TestCase):
    ...
    def test_MktValUSD(self):
        self.assertAlmostEqual(GetVal(self.trade, "MktValUSD"), 150.0, 8)

    def test_Deltas(self):
        self.assertEqual(GetVal(self.trade, "Deltas"),
                         Structure([("EQ NG/ LN", -1000.0)]))

    def test_Exposures(self):
        self.assertEqual(GetVal(self.trade, "GrossExposure"), 13500.0)
        self.assertEqual(GetVal(self.trade, "NetExposure"), -13500.0)
