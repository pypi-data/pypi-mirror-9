...
from onyx.core import GetVal, GetObj, Structure, ChildrenIterator

import agora.tradables.ufo_cash_balance as ufo_cash_balance
import unittest
...
class UnitTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.securities = ufo_cash_balance.prepare_for_test()
    ...
    def test_Children(self):
        kids = list(ChildrenIterator("CASH USD", "MktValUSD", "Spot"))
        self.assertEqual(kids, ["USD/USD"])
        kids = list(ChildrenIterator("CASH EUR", "MktValUSD", "Spot"))
        self.assertEqual(kids, ["EUR/USD"])
        kids = list(ChildrenIterator("CASH GBP", "MktValUSD", "Spot"))
