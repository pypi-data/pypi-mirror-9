...
def prepare_for_test():
    from onyx.core import Date, GetVal, SetDiddle
    ...
    SetDiddle("USD/USD", "Spot", 1.00)
    SetDiddle("EUR/USD", "Spot", 1.15)
    SetDiddle("GBP/USD", "Spot", 1.50)

    SetDiddle("USD/USD", "Last", Knot(Date.today(), GetVal("USD/USD", "Spot")))
    SetDiddle("EUR/USD", "Last", Knot(Date.today(), GetVal("EUR/USD", "Spot")))
    SetDiddle("GBP/USD", "Last", Knot(Date.today(), GetVal("GBP/USD", "Spot")))
