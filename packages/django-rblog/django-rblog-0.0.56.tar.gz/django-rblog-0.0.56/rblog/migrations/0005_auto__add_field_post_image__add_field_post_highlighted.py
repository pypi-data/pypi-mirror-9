...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rblog_post', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', null='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Post.highlighted'
        db.add_column('rblog_post', 'highlighted',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rblog_post', 'image')

        # Deleting field 'Post.highlighted'
        db.delete_column('rblog_post', 'highlighted')
