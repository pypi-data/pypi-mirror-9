...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.ptype'
        db.add_column('rblog_post', 'ptype',
                      self.gf('django.db.models.fields.CharField')(default='post', max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.ptype'
        db.delete_column('rblog_post', 'ptype')
    ...
    models = {
        ...
        'rblog.post': {
            ...
            'ptype': ('django.db.models.fields.CharField', [], {'default': "'post'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
