...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rblog_post', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Post.slug'
        db.alter_column('rblog_post', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
