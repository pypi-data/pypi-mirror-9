...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rblog_post', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['categories.Category'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.category'
        db.delete_column('rblog_post', 'category_id')
    ...
    models = {
        ...
        'rblog.post': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['categories.Category']", 'blank': 'True'}),
