...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.canonical'
        db.add_column('rblog_post', 'canonical',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Post', fields ['slug']
        db.create_unique('rblog_post', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Post', fields ['slug']
        db.delete_unique('rblog_post', ['slug'])

        # Deleting field 'Post.canonical'
        db.delete_column('rblog_post', 'canonical')
