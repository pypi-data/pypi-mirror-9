...
def n2g(thenumber, nomisma=False, case='title' ):
    ...
    >>> n2g(999999999999999999999.99)


    Ο αριθμός που δώσατε είναι πολύ μεγάλος για χειρισμό, ή δεν είνσι αριθμός: invalid literal for int() with base 10: '+'




    Ο αριθμός που δώσατε είναι πολύ μεγάλος για χειρισμό, ή δεν είνσι αριθμός: invalid literal for int() with base 10: '1e'


    Traceback (most recent call last):
      File "<pyshell#4>", line 1, in <module>
        n2g(999999999999999999999.99)
      File "/home/km/mytestenv/lib/python3.4/site-packages/numtogreek/numtogreek.py", line 195, in n2g
        temp = metatropi_ekatontadon(thenumber[-3:])
      File "/home/km/mytestenv/lib/python3.4/site-packages/numtogreek/numtogreek.py", line 123, in metatropi_ekatontadon
        apotelesma = apotelesma + metatropi_dekadon(arithmos[1:])
      File "/home/km/mytestenv/lib/python3.4/site-packages/numtogreek/numtogreek.py", line 80, in metatropi_dekadon
        if int(dekad) in dekades.keys():
