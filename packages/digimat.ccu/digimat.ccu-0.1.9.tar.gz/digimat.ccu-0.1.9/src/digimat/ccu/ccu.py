...
class CCUVirtualChannels(CCUDevice):
	def __init__(self, ccu):
		super(CCUVirtualChannels, self).__init__(ccu, 'bidcos-rf', 'ccu-vchannels')
		self._channels={}
...
class CCU:
	def __init__(self, name, urlCCU, urlEventServer=None, logger=None):
		...
		self._vchannels=CCUVirtualChannels(self)
