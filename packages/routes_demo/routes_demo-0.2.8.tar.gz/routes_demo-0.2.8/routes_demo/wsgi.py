...
from routes_demo.common import constants
from routes_demo.common import exceptions as exception
from routes_demo import context
# from neutron.db import api
from routes_demo.common import excutils
from routes_demo.common import gettextutils
from routes_demo.common import jsonutils
from routes_demo.common import log as logging
# from routes_demo.common import service as common_service
# from routes_demo.common import systemd
...
class Request(webob.Request):
    ...
    def best_match_language(self):
        ...
        if not self.accept_language:
            return None
        all_languages = gettextutils.get_available_languages('pardnet')
        return self.accept_language.best_match(all_languages)

    @property
    def context(self):
        if 'routes_demo.context' not in self.environ:
            self.environ['routes_demo.context'] = context.get_admin_context()
        return self.environ['routes_demo.context']
