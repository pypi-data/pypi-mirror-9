...
from routes_demo.common import exceptions as n_exc
...
RESOURCE_ATTRIBUTE_MAP = {
    CONTROLLERS: {
        ...
        'admin_state_up': {'allow_post': True, 'allow_put': True,
                           ...
                           'is_visible': True},
        'address': {'allow_post': True, 'allow_put': True,
...
#                       'is_visible': True},
    ...
    SWITCHES: {
        ...
        'controller_id': {'allow_post': True, 'allow_put': True,
               'validate': {'type:uuid': None},
               'is_visible': True},
        'node_type': {'allow_post': True, 'allow_put': True, 'default': 'OF',
                 'validate': {'type:string': None},
                 'is_visible': True},
        'dpid': {'allow_post': True, 'allow_put': True,
                 'validate': {'type:string': None},
                 'is_visible': True},
#         'tenant_id': {'allow_post': True, 'allow_put': False,
#                       'validate': {'type:string': None},
...
#                'validate': {'type:uuid': None},
        ...
        'session_persistence': {'allow_post': True, 'allow_put': True,
                                'convert_to': convert_none_to_empty_dict,
                                'default': {},
                                'validate': {
                                    'type:dict_or_empty': {
    ...
    'pools': {
        ...
        'provider': {'allow_post': True, 'allow_put': False,
                     'validate': {'type:string': None},
                     'is_visible': True, 'default': ATTR_NOT_SPECIFIED},
...
# }
# 
PLURALS = {CONTROLLERS: CONTROLLER,
           SWITCHES: SWITCH,
           HAPROXIES: HAPROXY,
           'pools': 'pool',
           'vips': 'vip',
