...
from routes_demo.rest_server import api_common
# from neutron.api.rpc.agentnotifiers import dhcp_rpc_agent_api
from routes_demo.rest_server import attributes
from routes_demo.rest_server import resource as wsgi_resource
from routes_demo.common import constants as const
from routes_demo.common import exceptions
...
#                 for obj in objs]})
            return {self._collection: [self._filter_attributes(
                request.context, obj, fields_to_strip=fields_to_strip)
                for obj in objs]}
        else:
