...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecordingJob.result'
        db.alter_column(u'liver_recordingjob', 'result', self.gf('django.db.models.fields.TextField')(max_length=50000, null=True))

        # Changing field 'RecordingSource.sources_group'
        db.alter_column(u'liver_recordingsource', 'sources_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liver.SourcesGroup'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'RecordingJob.result'
        db.alter_column(u'liver_recordingjob', 'result', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

        # Changing field 'RecordingSource.sources_group'
        db.alter_column(u'liver_recordingsource', 'sources_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['liver.SourcesGroup'], null=True))
    ...
    models = {
        ...
        u'liver.recorder': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'164ea012-a9f4-11e4-8d73-002590c1445a'", 'max_length': '5000'})
        },
        u'liver.recording': {
        ...
        u'liver.recordingjob': {
            ...
            'result': ('django.db.models.fields.TextField', [], {'default': "'None'", 'max_length': '50000', 'null': 'True', 'blank': 'True'}),
        ...
        u'liver.recordingsource': {
            ...
            'insertion_date': ('django.db.models.fields.DateTimeField', [], {}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'sources_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['liver.SourcesGroup']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        u'liver.source': {
