...
class TimeSeries:
    ...
    def _Load(self, filename=None,directory=None):
        self.Rows = []
        self.labels = []
        self.T = []
        if directory:
...
class Model:
    ...
    def Integrate(self,initial,maxdt=None,Calibration=None,TimeSeries=None,start=None,end=None):
