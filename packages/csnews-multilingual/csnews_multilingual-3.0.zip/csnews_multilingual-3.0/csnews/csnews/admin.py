...
class ArticleAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','title_eu', 'title_es', 'published','is_public',show_entry_thumbnail)
    list_display_links = ('id','title_es')
    ordering = ('-id',)        
    search_fields = ['title_es','title_eu','summary_eu','summary_es']
...
class TinyMCEArticleAdmin(ArticleAdmin):
    def formfield_for_dbfield(self, db_field, **kwargs):
        if db_field.name in ('body_es','body_eu','summary_eu','summary_es'):
            return db_field.formfield(widget=TinyMCE(
                ...
                mce_attrs={
                    ...
                    #'mode' : "textareas",
                    "mode" : "exact",
    		    "elements" : "body_es,body_eu,summary_eu,summary_es",
                    'plugins': "media",
