...
class JavaObjectArg:
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.string_arg = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.BOOL:
  ...
  def write(self, oprot):
    ...
    if self.string_arg is not None:
      ...
      oprot.writeString(self.string_arg)
      oprot.writeFieldEnd()
...
class JavaObject:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.full_class_name = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
  ...
  def write(self, oprot):
    ...
    if self.full_class_name is not None:
      ...
      oprot.writeString(self.full_class_name)
      oprot.writeFieldEnd()
...
class GlobalStreamId:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.componentId = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.componentId is not None:
      ...
      oprot.writeString(self.componentId)
      oprot.writeFieldEnd()
...
class ShellComponent:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.execution_command = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.execution_command is not None:
      ...
      oprot.writeString(self.execution_command)
      oprot.writeFieldEnd()
...
class ComponentCommon:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.json_conf = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.json_conf is not None:
      ...
      oprot.writeString(self.json_conf)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class SupervisorSummary:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.supervisor_id = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.supervisor_id is not None:
      ...
      oprot.writeString(self.supervisor_id)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class ExecutorSummary:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.component_id = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.component_id is not None:
      ...
      oprot.writeString(self.component_id)
      oprot.writeFieldEnd()
    if self.host is not None:
      oprot.writeFieldBegin('host', TType.STRING, 3)
      oprot.writeString(self.host)
...
class DRPCRequest:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.request_id = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.request_id is not None:
      ...
      oprot.writeString(self.request_id)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
