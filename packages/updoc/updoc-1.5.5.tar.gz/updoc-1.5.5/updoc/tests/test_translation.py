# -*- coding: utf-8 -*-
"""
Sample test module corresponding to the :mod:`updoc.translation` module.
...
import sys
import unittest
from updoc.translation import translation
__author__ = "flanker"
...
class TranslationTest(unittest.TestCase):
    ...
    :func:`updoc.sample.sample_function`."""
    # pylint: disable=R0904

    def test_translation(self):
        """Test the sample_function with two arguments."""
        __trans = translation('updoc', languages=['xx_XX'], fallback=True)
        _ = __trans.gettext
