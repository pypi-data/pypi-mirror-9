...
class TextField(Field):
    """ Store str/unicode typed object"""
    type = 'text'
...
class JSONField(Field):
    """ To store any JSON serializable Python objects """
    type = 'text'
...
class DatetimeField(Field):
    """ A datetime, represented in Python by a datetime.datetime instance. """
    type = 'timestamp'
