...
class BoxSession(object):
    ...
    def __init__(self, client_id, client_secret,
        ...
        self.refresh_token_method = refresh_token_method
    ...
    def __refresh_access_token(self):
        ...
        if self.refresh_token_method:
            log_debug('Refresh token method detected')
            log_debug(str(self.refresh_token_method))
            result = self.refresh_token_method()
            if result[0]:
                result = result[1]
                self.access_token = result['access_token']
                self.refresh_token = result['refresh_token']
            else:
                raise BoxError(494,"Error in refreshing token")
        else:
    ...
    def upload_file(self, name, folder_id, file_path, file_id=None):
        ...
        Args::
            ...
            file_id (int): ID of the existing file if you are uploading a new version of the file
    ...
    def __do_upload_file(self, name, folder_id, file_path, file_id):
        ...
        try:
            if file_id:
                ...
                url = "files/content"
            return self.__request("POST", url,
    ...
    def chunk_upload_file(self, name, folder_id, file_path,
        ...
        Args:
            ...
            file_id (int): ID of the existing file to be replaced with.
