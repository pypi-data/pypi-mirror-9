...
class RecordDaoES(object):
    ...
    def _make_es_connection(self, es_cfg):
        if es_cfg is None:
            ...
            port_as_integer = int(self._es_port
            timeout_as_integer = int(self._es_timeout)

            es = elasticsearch.Elasticsearch([{u'host': u'127.0.0.1', u'port': port_as_integer, u'timeout': timeout_as_integer }])
