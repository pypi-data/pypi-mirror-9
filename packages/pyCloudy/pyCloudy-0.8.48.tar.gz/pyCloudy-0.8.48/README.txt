...
You may find useful to download, install and upgrade pyCloudy using `pip <http://www.pip-installer.org/en/latest/index.html>`_.
...
* But... there is some examples of use in the `pyCloudy home page <https://sites.google.com/site/pycloudy/>`_.

* And the reference manual is accessible from this site `HERE <http://packages.python.org/pyCloudy/>`_.
