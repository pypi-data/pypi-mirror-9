"""
All credits for this file goes to simple-crypt (https://github.com/andrewcooke/simple-crypt)
Sadly we had to copy this file to our own code because the pypi packaging of simple-crypt is not
appropriate for the speedwise node users.
"""
