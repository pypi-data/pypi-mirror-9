...
class JsonSession(BasicSession):
    ...
    def get(self, location, data=None, headers={}):
        """Perform an HTTP GET."""
        return self._communicate(request.GetRequest, location, data, headers)

    def post(self, location, data=None, headers={}):
        """Perform an HTTP POST."""
        return self._communicate(request.PostRequest, location, data, headers)

    def put(self, location, data=None, headers={}):
        """Perform an HTTP PUT."""
        return self._communicate(request.PutRequest, location, data, headers)
