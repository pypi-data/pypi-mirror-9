...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.description1'
        db.add_column('rinvoices_invoice', 'description1',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Invoice.description2'
        db.add_column('rinvoices_invoice', 'description2',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Invoice.invoice_number'
        db.alter_column('rinvoices_invoice', 'invoice_number', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting field 'Invoice.description1'
        db.delete_column('rinvoices_invoice', 'description1')

        # Deleting field 'Invoice.description2'
        db.delete_column('rinvoices_invoice', 'description2')


        # Changing field 'Invoice.invoice_number'
        db.alter_column('rinvoices_invoice', 'invoice_number', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        'rinvoices.budget': {
            ...
            'price_per_line': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'retentions': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'budget_retentions'", 'to': "orm['rinvoices.Retention']"}),
        ...
        'rinvoices.header': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'budget_more': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'rinvoices.invoice': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_number': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '50'}),
