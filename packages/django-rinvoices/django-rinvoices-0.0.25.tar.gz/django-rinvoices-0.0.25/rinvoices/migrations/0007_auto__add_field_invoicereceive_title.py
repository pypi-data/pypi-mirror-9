...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoiceReceive.title'
        db.add_column('rinvoices_invoicereceive', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoiceReceive.title'
        db.delete_column('rinvoices_invoicereceive', 'title')
