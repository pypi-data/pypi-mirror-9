...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BudgetLine.concept'
        db.add_column('rinvoices_budgetline', 'concept',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'BudgetLine.quantity'
        db.add_column('rinvoices_budgetline', 'quantity',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BudgetLine.concept'
        db.delete_column('rinvoices_budgetline', 'concept')

        # Deleting field 'BudgetLine.quantity'
        db.delete_column('rinvoices_budgetline', 'quantity')
