...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Budget.subtotal_retentions'
        db.delete_column('rinvoices_budget', 'subtotal_retentions')

        # Deleting field 'Budget.subtotal_iva'
        db.delete_column('rinvoices_budget', 'subtotal_iva')

        # Deleting field 'Budget.subtotal'
        db.delete_column('rinvoices_budget', 'subtotal')


    def backwards(self, orm):
        # Adding field 'Budget.subtotal_retentions'
        db.add_column('rinvoices_budget', 'subtotal_retentions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Budget.subtotal_iva'
        db.add_column('rinvoices_budget', 'subtotal_iva',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Budget.subtotal'
        db.add_column('rinvoices_budget', 'subtotal',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
