...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvoiceReceive.paid'
        db.add_column('rinvoices_invoicereceive', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invoice.sent'
        db.add_column('rinvoices_invoice', 'sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invoice.charged'
        db.add_column('rinvoices_invoice', 'charged',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvoiceReceive.paid'
        db.delete_column('rinvoices_invoicereceive', 'paid')

        # Deleting field 'Invoice.sent'
        db.delete_column('rinvoices_invoice', 'sent')

        # Deleting field 'Invoice.charged'
        db.delete_column('rinvoices_invoice', 'charged')
