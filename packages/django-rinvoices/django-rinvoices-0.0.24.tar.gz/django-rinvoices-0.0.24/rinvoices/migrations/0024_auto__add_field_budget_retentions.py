...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Budget.retentions'
        db.add_column('rinvoices_budget', 'retentions',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='budget_retentions', to=orm['rinvoices.Retention']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Budget.retentions'
        db.delete_column('rinvoices_budget', 'retentions_id')
