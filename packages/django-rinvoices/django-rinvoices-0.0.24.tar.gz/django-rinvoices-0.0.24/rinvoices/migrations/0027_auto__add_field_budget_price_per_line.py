...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Budget.price_per_line'
        db.add_column('rinvoices_budget', 'price_per_line',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Budget.price_per_line'
        db.delete_column('rinvoices_budget', 'price_per_line')
