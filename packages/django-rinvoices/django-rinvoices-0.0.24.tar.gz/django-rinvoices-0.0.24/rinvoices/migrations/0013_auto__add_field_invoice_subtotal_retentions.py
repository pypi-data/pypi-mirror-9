...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.subtotal_retentions'
        db.add_column('rinvoices_invoice', 'subtotal_retentions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.subtotal_retentions'
        db.delete_column('rinvoices_invoice', 'subtotal_retentions')
