...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Retention'
        db.create_table('rinvoices_retention', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('rinvoices', ['Retention'])

        # Adding field 'Invoice.retentions'
        db.add_column('rinvoices_invoice', 'retentions',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='retentions', to=orm['rinvoices.Retention']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Retention'
        db.delete_table('rinvoices_retention')

        # Deleting field 'Invoice.retentions'
        db.delete_column('rinvoices_invoice', 'retentions_id')
    ...
    models = {
        ...
        'rinvoices.invoice': {
            ...
            'retentions': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'retentions'", 'to': "orm['rinvoices.Retention']"}),
