...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'BudgetLine.unit' to match new field type.
        db.rename_column('rinvoices_budgetline', 'unit', 'unit_id')
        # Changing field 'BudgetLine.unit'
        db.alter_column('rinvoices_budgetline', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rinvoices.QuantityUnit']))
        # Adding index on 'BudgetLine', fields ['unit']
        db.create_index('rinvoices_budgetline', ['unit_id'])


    def backwards(self, orm):
        # Removing index on 'BudgetLine', fields ['unit']
        db.delete_index('rinvoices_budgetline', ['unit_id'])


        # Renaming column for 'BudgetLine.unit' to match new field type.
        db.rename_column('rinvoices_budgetline', 'unit_id', 'unit')
        # Changing field 'BudgetLine.unit'
        db.alter_column('rinvoices_budgetline', 'unit', self.gf('django.db.models.fields.CharField')(max_length=200))
