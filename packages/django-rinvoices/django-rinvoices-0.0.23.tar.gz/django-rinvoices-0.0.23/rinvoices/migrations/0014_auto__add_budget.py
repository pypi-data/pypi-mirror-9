...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Budget'
        db.create_table('rinvoices_budget', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('header', self.gf('django.db.models.fields.related.ForeignKey')(related_name='budget_header', to=orm['rinvoices.Header'])),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='budget_customer', to=orm['rinvoices.Customer'])),
            ('sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='budget_currency', to=orm['rinvoices.Currency'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('subtotal', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('subtotal_iva', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('subtotal_retentions', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('total', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('rinvoices', ['Budget'])


    def backwards(self, orm):
        # Deleting model 'Budget'
        db.delete_table('rinvoices_budget')
