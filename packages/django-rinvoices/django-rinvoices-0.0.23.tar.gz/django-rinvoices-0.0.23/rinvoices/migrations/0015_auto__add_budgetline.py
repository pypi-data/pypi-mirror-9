...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rinvoices_budgetline', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('budget', self.gf('django.db.models.fields.related.ForeignKey')(related_name='budget_line', to=orm['rinvoices.Budget'])),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('rinvoices', ['BudgetLine'])


    def backwards(self, orm):
        # Deleting model 'BudgetLine'
        db.delete_table('rinvoices_budgetline')
