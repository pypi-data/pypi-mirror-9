...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Header.budget_more'
        db.add_column('rinvoices_header', 'budget_more',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Header.budget_more'
        db.delete_column('rinvoices_header', 'budget_more')
