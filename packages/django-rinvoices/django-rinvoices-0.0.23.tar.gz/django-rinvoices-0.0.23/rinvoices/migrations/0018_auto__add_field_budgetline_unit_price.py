...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BudgetLine.unit_price'
        db.add_column('rinvoices_budgetline', 'unit_price',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BudgetLine.unit_price'
        db.delete_column('rinvoices_budgetline', 'unit_price')
