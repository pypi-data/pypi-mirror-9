...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Budget.sent'
        db.delete_column('rinvoices_budget', 'sent')

        # Adding field 'Budget.description1'
        db.add_column('rinvoices_budget', 'description1',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Budget.description2'
        db.add_column('rinvoices_budget', 'description2',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Budget.sent'
        db.add_column('rinvoices_budget', 'sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Budget.description1'
        db.delete_column('rinvoices_budget', 'description1')

        # Deleting field 'Budget.description2'
        db.delete_column('rinvoices_budget', 'description2')
    ...
    models = {
        'rinvoices.budget': {
            ...
            'taxes': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
