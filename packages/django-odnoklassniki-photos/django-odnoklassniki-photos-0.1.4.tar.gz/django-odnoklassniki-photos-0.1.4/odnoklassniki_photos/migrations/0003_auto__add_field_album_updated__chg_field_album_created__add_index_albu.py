...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'odnoklassniki_photos_album', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
                      keep_default=False)


        # Changing field 'Album.created'
        db.alter_column(u'odnoklassniki_photos_album', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding index on 'Album', fields ['created']
        db.create_index(u'odnoklassniki_photos_album', ['created'])


    def backwards(self, orm):
        # Removing index on 'Album', fields ['created']
        db.delete_index(u'odnoklassniki_photos_album', ['created'])

        # Deleting field 'Album.updated'
        db.delete_column(u'odnoklassniki_photos_album', 'updated')


        # Changing field 'Album.created'
        db.alter_column(u'odnoklassniki_photos_album', 'created', self.gf('django.db.models.fields.DateField')(null=True))
