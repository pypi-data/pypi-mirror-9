...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.actions_count'
        db.add_column(u'odnoklassniki_photos_photo', 'actions_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.actions_count'
        db.delete_column(u'odnoklassniki_photos_photo', 'actions_count')
