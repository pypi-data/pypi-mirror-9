...
class Parameters:
    def __init__(self):
        ...
        self.interactive = True # whether Ctrax was started in interactive mode or not
        ...
        self.enforce_minmax_shape = True
...
class GUIConstants:
    def __init__( self ):
        ...
        self.info.SetCopyright( "2007-2014, Caltech ethomics project" )
