...
data_files = [
    ...
    ('share/ardj/audio', ['share/audio/stefano_mocini_leaving_you_failure_edit.ogg']),
    ('share/ardj/audio', ['share/audio/cubic_undead.mp3', 'share/audio/successful_install.ogg']),
    ('share/ardj/shell-extensions/zsh', ['share/shell-extensions/zsh/_ardj']),
    ('share/doc/ardj', ('NEWS', 'README.md', 'TODO')),
