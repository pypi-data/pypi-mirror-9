...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FreeTime'
        db.create_table(u'freckle_budgets_freetime', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['freckle_budgets.Employee'])),
            ('day', self.gf('django.db.models.fields.DateField')()),
            ('is_public_holiday', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_sick_leave', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'freckle_budgets', ['FreeTime'])


    def backwards(self, orm):
        # Deleting model 'FreeTime'
        db.delete_table(u'freckle_budgets_freetime')
    ...
    models = {
        ...
        u'freckle_budgets.freetime': {
            'Meta': {'ordering': "['employee', '-day']", 'object_name': 'FreeTime'},
            'day': ('django.db.models.fields.DateField', [], {}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['freckle_budgets.Employee']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public_holiday': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_sick_leave': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
