...
C 23400 64800 1 180 1 three_port_kerr_cavity-3.sym
{
T 23695 62505 5 8 0 0 180 6 1
device=ThreePortKerrCavity
T 24500 64400 5 8 1 1 180 6 1
refdes=Filter
T 23800 65600 5 10 1 0 0 0 1
kappa_1=kappa_F
T 23800 65400 5 10 1 0 0 0 1
kappa_2=gamma_F
T 23800 65200 5 10 1 0 0 0 1
kappa_3=eta_F
T 23800 64800 5 10 1 0 0 0 1
chi=0
T 23800 65000 5 10 1 0 0 0 1
Delta=Delta_F
}
N 24000 64100 22500 64100 4
C 28100 64300 1 180 0 output-1.sym
{
T 28100 63400 5 10 0 0 180 0 1
device=OPAD
T 28100 64100 5 10 1 1 0 0 1
refdes=sb_ref
T 28100 64300 5 10 1 0 0 0 1
pinseq=o1
}
...
params=kappa:real;Delta:real;delta:real;gamma:real;eta:real;chi:real;chi_C:real;phi_1:real:3.14159265359;phi_2:real:-3.14159265359;kappa_F:real;gamma_F:real;eta_F:real;Delta_F:real;Delta_A:real;kappa_A:real;chi_A:real;phi:real;eta_A:real;theta:real
N 20800 62500 21300 62500 4
T 19500 66800 8 10 1 1 0 0 1
module-name=PhaseLock3
N 26200 64100 25400 64100 4
C 25200 65400 1 180 1 beamsplitter-1.sym
{
T 27200 63300 5 10 0 0 0 2 1
device=Beamsplitter
T 27200 63700 5 10 1 1 90 6 1
refdes=BS
T 25900 64300 5 10 1 0 90 6 1
theta=theta
}
N 26700 63600 26700 62800 4
