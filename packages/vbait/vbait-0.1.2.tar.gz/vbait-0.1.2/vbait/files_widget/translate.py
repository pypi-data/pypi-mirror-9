# coding=utf-8
TRANS_LETTER_RUSSIAN = ['А', 'Б', 'В', 'Г', 'Д', 'Е', 'Ё', 'Є', 'Ж', 'З', 'И', 'І',
                        'Й', 'К', 'Л', 'М', 'Н', 'О', 'П', 'Р', 'С', 'Т', 'У', 'Ф',
                        'Х', 'Ц', 'Ч', 'Ш', 'Щ', 'Ъ', 'Ы', 'Ь', 'Э', 'Ю', 'Я']

TRANS_LETTER_RLATIN  = ['A', 'B', 'V', 'G', 'D', 'E', 'E', 'E', 'ZH', 'Z', 'I', 'I',
...
RU_ALPHABET = [x[0] for x in TRANS_LETTER]
EN_ALPHABET = [x[1] for x in TRANS_LETTER]

def trans(in_string=u''):
    translit = in_string
    for symb_in, symb_out in TRANS_LETTER:
