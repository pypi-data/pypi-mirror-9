...
class MailSocialUser(AbstractMailUser):
    ...
    """
    likes = models.ManyToManyField('self', blank=True, null=True, related_name='liked', symmetrical=False)
    follows = models.ManyToManyField('self', blank=True, null=True, related_name='followed', symmetrical=False)
