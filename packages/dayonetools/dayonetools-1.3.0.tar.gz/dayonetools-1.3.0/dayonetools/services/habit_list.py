...
list.  This can be done by the following:
    ...
    - Copy and paste the e-mail contents into a file of your choosing
        - Remove any lines at the end of the file that appear outside of the
          last '[' character that will cause the script to NOT process the JSON
          data.
...
def parse_habits_file(filename, start_date=None):
    ...
    with open(filename, 'r') as file_obj:
        ...
        # Strip off common ending when saving email from habit list backup if
        # it exists
        _json = _json.split('Sent from my iPhone\n')[0]
