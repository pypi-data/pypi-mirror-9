...
class Pcz:
    ...
    def avg(self):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(p.avg()[0], np.array([ 31.32314981, 61.57537998, 40.13629822])))
        True
    ...
    def eval(self, ival):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(p.eval(4), np.array([2.61839402408])))
        True
    ...
    def evals(self):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(p.evals()[4], np.array([2.61839402408])))
        True
    ...
    def evec(self, ivec):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> print(np.allclose(p.evec(1)[12], np.array([-0.00865751376637])))
        True
    ...
    def evecs(self):
        ...
        >>> element = e[1,12]
        >>> print(np.allclose(element, np.array([-0.00865751376637])))
        True
    ...
    def proj(self, iproj):
        ...
        >>> p = Pcz(c)
        >>> prj = p.proj(3)
        >>> print(np.allclose(prj[21], 0.345995549248))
        True
    ...
    def scores(self, framenumber):
        ...
        >>> p = Pcz(c)
        >>> s = p.scores(12)
        >>> print(np.allclose(s[3], 0.59478410369))
        True
    ...
    def expand(self, scores):
        ...
        >>> c = cofasu.Cofasu(f)
        >>> p = Pcz(c)
        >>> e = p.expand([1.0, 2.0, 3.0])
        >>> print(np.allclose(e[3:6], [-2.54398614, 0.95734313, 2.21445192]))
        True
    ...
    def map(self,crds):
        ...
        >>> print(np.allclose(p.map(crds)[:3],[0.38448033,-1.6537842, -2.29433986 ]))
        True
