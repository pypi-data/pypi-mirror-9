...
def pcazip(args):
    ...
    if args.centre is not None:
        ...
        if rank == 0:
            log.info('Will place group {} at centre of box to fix jumps'.format(args.centre))
    else:
        tfunc = None
        kwargs = {}
    ...
    if args.trj_output is not None:
        ...
        log.info('Wrote selected frames and atoms to trajectory file {}'.format(args.trj_output))
