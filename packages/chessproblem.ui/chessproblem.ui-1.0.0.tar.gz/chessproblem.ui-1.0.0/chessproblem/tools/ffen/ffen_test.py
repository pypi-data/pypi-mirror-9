...
from chessproblem.tools.ffen import ffen, _ffen_piece, _ffen_piece_name, _ffen_piece_rotation
...
class FFENTest(unittest.TestCase):
    ...
    def test_empty_normal_board(self):
        self.assertEqual('8/8/8/8/8/8/8/8', ffen(self.empty_problem))

    def test_empty_3x4_board(self):
        self.assertEqual('3/3/3/3', ffen(self._create_problem_from_string(
    ...
    def test_extended_party_starting_position_normal(self):
        self.assertEqual('rnbqkbnr/pppppppp/8/-p-p-p-p-p-p-p-p/-r-n-b-q-k-b-n-r/8/PPPPPPPP/RNBQKBNR',
                ffen(self._create_problem_from_string('''\\begin{diagram}\\pieces{wKe1, wDd1, wTa1h1, wLc1f1, wSb1g1, wBa2b2c2d2e2f2g2h2, nKe4, nDd4, nTa4h4, nLc4f4, nSb4g4, nBa5b5c5d5e5f5g5h5, sKe8, sDd8, sTa8h8, sLc8f8, sSb8g8, sBa7b7c7d7e7f7g7h7}\\end{diagram}''')))
    ...
    def test_extended_party_starting_position_left(self):
        ...
        self.assertEqual('*3r*3n*3b*3q*3k*3b*3n*3r/*3p*3p*3p*3p*3p*3p*3p*3p/8/-*3p-*3p-*3p-*3p-*3p-*3p-*3p-*3p/-*3r-*3n-*3b-*3q-*3k-*3b-*3n-*3r/8/*3P*3P*3P*3P*3P*3P*3P*3P/*3R*3N*3B*3Q*3K*3B*3N*3R',
                ffen(self._create_problem_from_string('''\\begin{diagram}\\pieces{wKLe1, wDLd1, wTLa1h1, wLLc1f1, wSLb1g1, wBLa2b2c2d2e2f2g2h2, nKLe4, nDLd4, nTLa4h4, nLLc4f4, nSLb4g4, nBLa5b5c5d5e5f5g5h5, sKLe8, sDLd8, sTLa8h8, sLLc8f8, sSLb8g8, sBLa7b7c7d7e7f7g7h7}\\end{diagram}''')))
    ...
    def test_extended_party_starting_position_upsidedown(self):
        ...
        self.assertEqual('*2r*2n*2b*2q*2k*2b*2n*2r/*2p*2p*2p*2p*2p*2p*2p*2p/8/-*2p-*2p-*2p-*2p-*2p-*2p-*2p-*2p/-*2r-*2n-*2b-*2q-*2k-*2b-*2n-*2r/8/*2P*2P*2P*2P*2P*2P*2P*2P/*2R*2N*2B*2Q*2K*2B*2N*2R',
                ffen(self._create_problem_from_string('''\\begin{diagram}\\pieces{wKUe1, wDUd1, wTUa1h1, wLUc1f1, wSUb1g1, wBUa2b2c2d2e2f2g2h2, nKUe4, nDUd4, nTUa4h4, nLUc4f4, nSUb4g4, nBUa5b5c5d5e5f5g5h5, sKUe8, sDUd8, sTUa8h8, sLUc8f8, sSUb8g8, sBUa7b7c7d7e7f7g7h7}\\end{diagram}''')))
    ...
    def test_extended_party_starting_position_right(self):
        ...
        self.assertEqual('*1r*1n*1b*1q*1k*1b*1n*1r/*1p*1p*1p*1p*1p*1p*1p*1p/8/-*1p-*1p-*1p-*1p-*1p-*1p-*1p-*1p/-*1r-*1n-*1b-*1q-*1k-*1b-*1n-*1r/8/*1P*1P*1P*1P*1P*1P*1P*1P/*1R*1N*1B*1Q*1K*1B*1N*1R',
                ffen(self._create_problem_from_string('''\\begin{diagram}\\pieces{wKRe1, wDRd1, wTRa1h1, wLRc1f1, wSRb1g1, wBRa2b2c2d2e2f2g2h2, nKRe4, nDRd4, nTRa4h4, nLRc4f4, nSRb4g4, nBRa5b5c5d5e5f5g5h5, sKRe8, sDRd8, sTRa8h8, sLRc8f8, sSRb8g8, sBRa7b7c7d7e7f7g7h7}\\end{diagram}''')))
