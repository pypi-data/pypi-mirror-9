...
##-----------------------------------------------------------------------------
def children_iterator(obj_name, VT, child_VT):
    for name, vt in onyx_dg.graph[(obj_name, VT)].children:
        if vt == child_VT:
            yield name
        else:
            for kid in children_iterator(name, vt, child_VT):
                yield kid


##-----------------------------------------------------------------------------
def ChildrenSet(obj, VT, child_VT):
    """
    Description:
    ...
    return set(children_iterator(obj, VT, child_VT))
