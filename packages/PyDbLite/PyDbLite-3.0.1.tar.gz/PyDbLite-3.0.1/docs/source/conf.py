# -*- coding: utf-8 -*-
#
# PyDbLite documentation build configuration file, created by
...
project = u'PyDbLite'
copyright = u'2014, Pierre Quentel, Bendik Rønning Opstad'
...
html_sidebars = {'**': ['globaltoc.html',
                        ...
                        'testing.html',
                        'contact.html',
                        'searchbox.html']}  # 'custom_sidebar.html'

download_link = "http://sourceforge.net/project/platformdownload.php?group_id=210258"
...
latex_documents = [
    ('index', 'PyDbLite.tex', u'PyDbLite Documentation',
     u'Pierre Quentel \& Bendik Rønning Opstad', 'manual'),
]
...
man_pages = [
    ('index', 'pydblite', u'PyDbLite Documentation',
     [u'Pierre Quentel'], 1)
]
...
texinfo_documents = [
    ('index', 'PyDbLite', u'PyDbLite Documentation',
     u'Pierre Quentel', 'PyDbLite', 'One line description of project.',
     'Miscellaneous'),
]
