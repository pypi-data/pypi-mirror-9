...
class SMSRU(object):
    ...
    def __init__(self, api_id=None, debug=None, test=None, sendername=None,
                 time=None, translit=None, http_timeout=None):
    ...
    def send_one(self, phone_to, message):
        ...
        self._show_debug_messages(u'URL: {0}'.format(url))
