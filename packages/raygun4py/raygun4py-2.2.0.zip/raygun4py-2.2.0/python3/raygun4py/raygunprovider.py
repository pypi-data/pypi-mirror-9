...
class RaygunSender:
    ...
    def send_exception(self, exception, tags = None, userCustomData = None, httpRequest = None):
        rgExcept = raygunmsgs.RaygunErrorMessage(type(exception), exception, exception.__traceback__)
