...
.. image:: https://api.travis-ci.org/chfw/pyexcel.svg?branch=v0.1.2
    :target: https://travis-ci.org/chfw/pyexcel/builds/48206323

.. image:: https://coveralls.io/repos/chfw/pyexcel/badge.png?branch=v0.1.2
    :target: https://coveralls.io/r/chfw/pyexcel?branch=v0.1.1

.. image:: https://readthedocs.org/projects/pyexcel/badge/?version=v0.1.2
    :target: http://pyexcel.readthedocs.org/en/v0.1.2
