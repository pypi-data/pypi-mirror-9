...
class BulkCampaignNegativeKeyword(_BulkEntityNegativeKeyword):
    ...
    For more information, see Campaign Negative Keyword at http://go.microsoft.com/fwlink/?LinkID=511522.
...
class BulkNegativeKeywordList(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self._negative_keyword_list = _CAMPAIGN_OBJECT_FACTORY.create('NegativeKeywordList')
...
class BulkSharedNegativeKeyword(_BulkNegativeKeyword):
    ...
    For more information, see Shared Negative Keyword at http://go.microsoft.com/fwlink/?LinkID=511520.
