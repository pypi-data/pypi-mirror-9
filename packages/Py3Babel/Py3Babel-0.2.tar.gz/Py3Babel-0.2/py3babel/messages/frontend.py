...
from py3babel import __version__ as VERSION
from py3babel import Locale, localedata
from py3babel.core import UnknownLocaleError
from py3babel.messages.catalog import Catalog
from py3babel.messages.extract import extract_from_dir, DEFAULT_KEYWORDS, \
                                   DEFAULT_MAPPING
from py3babel.messages.mofile import write_mo
from py3babel.messages.pofile import read_po, write_po
from py3babel.util import odict, LOCALTZ
from py3babel._compat import string_types, BytesIO, PY2
...
class compile_catalog(Command):
    ...
    the command needs to be registered explicitly in ``setup.py``::
        ...
        from py3babel.messages.frontend import compile_catalog
...
class extract_messages(Command):
    ...
    the command needs to be registered explicitly in ``setup.py``::
        ...
        from py3babel.messages.frontend import extract_messages
...
class init_catalog(Command):
    ...
    the command needs to be registered explicitly in ``setup.py``::
        ...
        from py3babel.messages.frontend import init_catalog
...
class update_catalog(Command):
    ...
    the command needs to be registered explicitly in ``setup.py``::
        ...
        from py3babel.messages.frontend import update_catalog
