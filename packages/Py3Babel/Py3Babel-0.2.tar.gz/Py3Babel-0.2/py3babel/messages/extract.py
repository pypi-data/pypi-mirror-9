...
from py3babel.util import parse_encoding, pathmatch, relpath
from py3babel._compat import PY2, text_type
...
def extract_javascript(fileobj, keywords, comment_tags, options):
    ...
    :param options: a dictionary of additional options (optional)
    """
    from py3babel.messages.jslexer import tokenize, unquote_string
