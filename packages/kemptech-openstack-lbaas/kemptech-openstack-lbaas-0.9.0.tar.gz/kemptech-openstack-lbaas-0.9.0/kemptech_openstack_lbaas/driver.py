...
class LoadBalancerManager(object):
    ...
    def __init__(self, kemp_client, api_helper):
        self.client = kemp_client
...
class ListenerManager(object):
    ...
    def __init__(self, client, api_helper):
        self.client = client
        self.api_helper = api_helper
    ...
    def create(self, context, listener):
        ...
        client.create_virtual_service(prep_listener)
...
class KempLoadMasterDriver(object):
    ...
    def load_balancer(self):
        return LoadBalancerManager(client, self.api_helper)

    @property
    def listener(self):
        return ListenerManager(client, self.api_helper)

    @property
    def pool(self):
        return PoolManager(client, self.api_helper)

    @property
    def member(self):
        return MemberManager(client, self.api_helper)

    @property
    def health_monitor(self):
        return HealthMonitorManager(client, self.api_helper)
