...
class Shm(Interface):
    ...
    Clients can create :class:`~pywayland.protocol.shmpool.ShmPool` objects using the create_pool
    request.

    At connection setup time, the :class:`Shm` object emits one or more
...
def create_pool(self, fd, size):
    ...
    Create a new :class:`~pywayland.protocol.shmpool.ShmPool` object.
    ...
    :param size:
    :type size: `int`
    :returns: :class:`~pywayland.protocol.shmpool.ShmPool`
    """
