...
_cffi_f_wl_proxy_add_dispatcher(PyObject *self, PyObject *args)
{
  ...
  x1 = (int(*)(void const *, void *, uint32_t, struct wl_message const *, union wl_argument *))_cffi_to_c_pointer(arg1, _cffi_type(5));
...
{
  PyObject *lib;
  lib = Py_InitModule("_pywayland", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
