...
setup(
    ...
    download_url="https://github.com/jamiesonbecker/pyindent/archive/master.tar.gz",
    ...
    keywords='indenting console development',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=['pyindent'], #find_packages(exclude=['contrib', 'docs', 'tests*']),
