...
from epic import perms, BILL_TO_ADDRESS, SHIPPING_TYPE, SHIPPING_ACCOUNT
...
def order_export(request, pk):
    ...
    for l in BILL_TO_ADDRESS.split('\n'):
    ...
    ww.append(SHIPPING_TYPE, style_normal)
    ww.next_row()

    ww.append('Shipping Account', style_title)
    ww.append(SHIPPING_ACCOUNT, style_normal)
    ww.next_row()
    ww.next_row()
