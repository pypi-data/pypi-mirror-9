...
class IInputControl(IControl):
    """HTML5 input control base class"""
...
class IHiddenControl(IInputControl):
    """Input control type="hidden"""


class IFileControl(IInputControl):
    """Input control type="file"""


class IPasswordControl(IInputControl):
    """Input control type="password"""


class ITextControl(IInputControl):
    """HTML5 input control type="text"""


class IEMailControl(IInputControl):
    """HTML5 input control type="email"""


class IDateControl(IInputControl):
    """HTML5 input control type="date"""


class IDatetimeControl(IInputControl):
    """HTML5 input control type="datetime"""


class IDatetimeLocalControl(IInputControl):
    """HTML5 input control type="datetime-local"""


class ITimeControl(IInputControl):
    """HTML5 input control type="time"""


class IWeekControl(IInputControl):
    """HTML5 input control type="week"""


class IMonthControl(IInputControl):
    """HTML5 input control type="month"""


class IColorControl(IInputControl):
    """HTML5 input control type="color"""


class ISearchControl(IInputControl):
    """HTML5 input control type="search"""


class IURLControl(IInputControl):
    """HTML5 input control type="url"""


class INumberControl(IInputControl):
    """HTML5 input control type="number"""


class ITelControl(IInputControl):
...
class IRadioControl(IControl):
    """Radio control"""


class ISelectControl(IControl):
    """Select control"""


class ICheckboxControl(IControl):
    """Checkbox control"""
...
class IRadioListControl(IListControl):
    """List of RadioControl"""


class ISelectListControl(IListControl):
    """List of SelectControl"""


class ICheckboxListControl(IListControl):
...
class IButtonControl(ISubmitControl):
...
# j01.jsonrpc
class IJSONRPCButtonControl(ISubmitControl):
    """JSONRPCButton control given from j01.jsonrpc.btn

    Use the getControl method for get this control and process them with the
    click method with something like:
...
class IJSONRPCClickButtonControl(IJSONRPCButtonControl):
...
class IJSONRPCContentButtonControl(IJSONRPCButtonControl):
...
class ICloseButtonControl(ISubmitControl):
    """CloseButton control given from j01.jsonrpc.btn
...
class IJSONRPCClickControl(IControl):
    """JSONRPC click control given from j01.jsonrpc.link

    NOTE: this is not a button or a link. You can get such a control with
    getClickablemethod and process the with the click method.
    The reason that you can't use getControl is that the webtest will not
    collect the clickable element as form control and the getControl will only
    return form controls.

    Use the getClickable method for get this control and process them with the
    click method with something like:

        clickable = browser.getClickable(label=None, name=None, index=None)
        clickable.click()

    """

    def click():
        """Process the action with a click simulation"""


# j01.dialog
class IDialogButtonControl(IJSONRPCButtonControl):
...
class IDialogContentButtonControl(IJSONRPCButtonControl):
...
class IShowDialogButtonControl(IJSONRPCButtonControl):
...
class IDialogCloseButtonControl(ISubmitControl):
...
class IDialogLinkControl(IControl):
