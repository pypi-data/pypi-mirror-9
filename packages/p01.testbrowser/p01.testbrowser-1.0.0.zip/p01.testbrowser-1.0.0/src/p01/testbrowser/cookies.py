...
from p01.testbrowser._compat import httpcookies
from p01.testbrowser._compat import urlparse
from p01.testbrowser._compat import url_quote
from p01.testbrowser._compat import MutableMapping
...
from p01.testbrowser import utils
...
class Cookies(MutableMapping):
    ...
    def create(self, name, value,
        ...
        if expires is not None and self._is_expired(expires, now):
            raise p01.testbrowser.exceptions.AlreadyExpiredError(
