...
class Browser(object):
    """p01.testbrowser.testing.Browser is no longer supported.

    Please use p01.testbrowser.wsgi.Browser() in conjuction with
    zope.app.wsgi.testlayer.BrowserLayer(), or some other custom test layer
    that inherits from p01.testbrowser.wsgi.Layer.

    Alternatively pin p01.testbrowser version to < 5.0.0 if you don't care
