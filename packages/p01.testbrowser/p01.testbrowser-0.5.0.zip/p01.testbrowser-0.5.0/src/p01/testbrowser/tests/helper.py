...
checker = zope.testing.renormalizing.RENormalizing([
    ...
    (re.compile(r'p01.testbrowser.browser.BrowserStateError'), 'BrowserStateError'),
    (re.compile(r'p01.testbrowser.interfaces.ExpiredError'), 'ExpiredError'),
    (re.compile(r'p01.testbrowser.browser.LinkNotFoundError'), 'LinkNotFoundError'),
    (re.compile(r'p01.testbrowser.browser.AmbiguityError'), 'AmbiguityError'),
    (re.compile(r'p01.testbrowser.ftests.wsgitestapp.NotFound'), 'NotFound'),
    (re.compile(r'p01.testbrowser.interfaces.AlreadyExpiredError'), 'AlreadyExpiredError'),
    (re.compile(r'p01.testbrowser.browser.RobotExclusionError'), 'RobotExclusionError'),
    (re.compile(r'urllib.error.HTTPError'), 'HTTPError'),


    # In py3 HTTPMessage class was moved and represented differently
    (re.compile(r'<http.client.HTTPMessage object'), '<httplib.HTTPMessage instance'),
    #(re.compile(r''), ''),
    ])
