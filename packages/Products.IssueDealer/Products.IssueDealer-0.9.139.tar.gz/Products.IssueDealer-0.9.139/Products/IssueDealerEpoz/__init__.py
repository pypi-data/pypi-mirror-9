...
'epoz_script_widget.js':ImageFile('skins/epoz/epoz_script_widget.js.dtml', globals()),

 # Browser-detection
'epoz_script_detect.js':ImageFile('skins/epoz/epoz_script_detect.js.dtml', globals()),

 # Code for the color-selection-popup
'epoz_script_color.html':ImageFile('skins/epoz/epoz_script_color.html.dtml', globals()),

 # Code for the table-popup
'epoz_script_table.html':ImageFile('skins/epoz/epoz_script_table.html.dtml', globals()),

 # The XMLRPC-handler
'vcXMLRPC.js':ImageFile('skins/epoz/vcXMLRPC.js.dtml', globals()),

 # The Epoz-Language-Files
'epoz_lang_da.js':ImageFile('skins/epoz/epoz_lang_da.js.dtml', globals()),
'epoz_lang_de.js':ImageFile('skins/epoz/epoz_lang_de.js.dtml', globals()),
'epoz_lang_en.js':ImageFile('skins/epoz/epoz_lang_en.js.dtml', globals()),
'epoz_lang_es.js':ImageFile('skins/epoz/epoz_lang_es.js.dtml', globals()),
'epoz_lang_fi.js':ImageFile('skins/epoz/epoz_lang_fi.js.dtml', globals()),
'epoz_lang_fr.js':ImageFile('skins/epoz/epoz_lang_fr.js.dtml', globals()),
'epoz_lang_hu.js':ImageFile('skins/epoz/epoz_lang_hu.js.dtml', globals()),
'epoz_lang_it.js':ImageFile('skins/epoz/epoz_lang_it.js.dtml', globals()),
'epoz_lang_nl.js':ImageFile('skins/epoz/epoz_lang_nl.js.dtml', globals()),
'epoz_lang_no.js':ImageFile('skins/epoz/epoz_lang_no.js.dtml', globals()),
'epoz_lang_pl.js':ImageFile('skins/epoz/epoz_lang_pl.js.dtml', globals()),
'epoz_lang_pt.js':ImageFile('skins/epoz/epoz_lang_pt.js.dtml', globals()),
'epoz_lang_pt-br.js':ImageFile('skins/epoz/epoz_lang_pt-br.js.dtml', globals()),
'epoz_lang_ru.js':ImageFile('skins/epoz/epoz_lang_ru.js.dtml', globals()),
'epoz_lang_zh-cn.js':ImageFile('skins/epoz/epoz_lang_zh-cn.js.dtml', globals()),

 # The Epoz-Buttons
'epoz_button_anchor.gif':ImageFile('skins/epoz/epoz_button_anchor.gif', globals()),
'epoz_button_bgcolor.gif':ImageFile('skins/epoz/epoz_button_bgcolor.gif', globals()),
'epoz_button_bold.gif':ImageFile('skins/epoz/epoz_button_bold.gif', globals()),
'epoz_button_centre.gif':ImageFile('skins/epoz/epoz_button_centre.gif', globals()),
'epoz_button_hr.gif':ImageFile('skins/epoz/epoz_button_hr.gif', globals()),
'epoz_button_hyperlink.gif':ImageFile('skins/epoz/epoz_button_hyperlink.gif', globals()),
'epoz_button_image.gif':ImageFile('skins/epoz/epoz_button_image.gif', globals()),
'epoz_button_file.gif':ImageFile('skins/epoz/epoz_button_file.gif', globals()),
'epoz_button_indent.gif':ImageFile('skins/epoz/epoz_button_indent.gif', globals()),
'epoz_button_italic.gif':ImageFile('skins/epoz/epoz_button_italic.gif', globals()),
'epoz_button_left_just.gif':ImageFile('skins/epoz/epoz_button_left_just.gif', globals()),
'epoz_button_list.gif':ImageFile('skins/epoz/epoz_button_list.gif', globals()),
'epoz_button_numbered_list.gif':ImageFile('skins/epoz/epoz_button_numbered_list.gif', globals()),
'epoz_button_outdent.gif':ImageFile('skins/epoz/epoz_button_outdent.gif', globals()),
'epoz_button_redo.gif':ImageFile('skins/epoz/epoz_button_redo.gif', globals()),
'epoz_button_right_just.gif':ImageFile('skins/epoz/epoz_button_right_just.gif', globals()),
'epoz_button_strikethrough.gif':ImageFile('skins/epoz/epoz_button_strikethrough.gif', globals()),
'epoz_button_subscript.gif':ImageFile('skins/epoz/epoz_button_subscript.gif', globals()),
'epoz_button_superscript.gif':ImageFile('skins/epoz/epoz_button_superscript.gif', globals()),
'epoz_button_table.gif':ImageFile('skins/epoz/epoz_button_table.gif', globals()),
'epoz_button_textcolor.gif':ImageFile('skins/epoz/epoz_button_textcolor.gif', globals()),
'epoz_button_tools.gif':ImageFile('skins/epoz/epoz_button_tools.gif', globals()),
'epoz_button_underline.gif':ImageFile('skins/epoz/epoz_button_underline.gif', globals()),
'epoz_button_undo.gif':ImageFile('skins/epoz/epoz_button_undo.gif', globals()),
'epoz_button_unformat.gif':ImageFile('skins/epoz/epoz_button_unformat.gif', globals()),
}


def IssueDealerEpoz(self, name, data='', toolbox='', lang='en',
               path='', widget='',
    ...
    if not path:
        path = "%s/misc_/IssueDealerEpoz/" % (self.REQUEST.get('BASEPATH1',''),)
...
<!--
InitEpoz('%(name)s','%(js_data)s','%(path)s','%(toolbox)s','%(style)s','%(button)s','%(css)s','%(customcss)s','%(charset)s', '%(pageurl)s', '%(image_edit_url)s');
//-->
</script>
...
IssueDealerEpoz.__replaceable__ = Globals.REPLACEABLE
...
methods = {
'IssueDealerEpoz': IssueDealerEpoz,
'EpozTidy': EpozTidy,
'EpozGetRelativeUrl': EpozGetRelativeUrl,
'epoz_blank_iframe.html': PageTemplateFile('skins/epoz/epoz_blank_iframe.html.pt',
                          globals()) ,
}
