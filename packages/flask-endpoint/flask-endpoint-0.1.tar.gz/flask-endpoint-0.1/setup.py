...
class PyTest(TestCommand):
    def finalize_options(self):
        ...
        self.test_args = ['test_flask_endpoint.py']
...
setup(
    name='flask-endpoint',
    version='0.1',
    url='http://github.com/rhyselsmore/flask-endpoint',
    author='Rhys Elsmore',
    author_email='me@rhys.io',
    description='Endpoint based routing for Flask. Simple.',
    py_modules=['flask_endpoint'],
