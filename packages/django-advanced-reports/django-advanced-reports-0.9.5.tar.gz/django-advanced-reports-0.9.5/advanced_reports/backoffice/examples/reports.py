...
class UserReport(BootstrapReport):
    ...
    @action('New user', form=UserForm, is_report_action=True, css_class='btn-primary', regular_view=True)
    def new(self, form):
        return HttpResponse(form.as_p())

    @action('New user 2', form=UserForm, is_report_action=True, css_class='btn-success')
    def new2(self, form):
        pass
