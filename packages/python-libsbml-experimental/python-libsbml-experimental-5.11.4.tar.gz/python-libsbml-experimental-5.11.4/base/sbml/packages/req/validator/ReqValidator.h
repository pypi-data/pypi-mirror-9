...
#ifndef ReqValidator__H
#define ReqValidator__H
...
class ReqValidator : public Validator
{
public:

  /**
   * Constructor; creates a new ReqValidator object for the given
   ...
   */
  ReqValidator ( SBMLErrorCategory_t category = LIBSBML_CAT_SBML );


  /**
   * Destroys this ReqValidator object.
   */
  virtual ~ReqValidator ();


  /**
   * Initializes this ReqValidator object.
   *
   * When creating a subclass of ReqValidator, override this method to add
...
protected:
  ...
  ReqValidatorConstraints* mReqConstraints;

  friend class ReqValidatingVisitor;
