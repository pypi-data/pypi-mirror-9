/**
 * @file:   ReqExtensionTypes.h
 * @brief:  Implementation of the ReqExtensionTypes class
 * @author: SBMLTeam
 *
 * <!--------------------------------------------------------------------------
 ...
 * ------------------------------------------------------------------------ -->
 */
#ifndef ReqExtensionTypes_H
#define ReqExtensionTypes_H
