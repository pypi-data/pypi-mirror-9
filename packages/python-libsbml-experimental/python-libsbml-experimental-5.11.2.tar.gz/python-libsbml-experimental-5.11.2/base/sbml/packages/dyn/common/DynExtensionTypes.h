/**
 * @file:   DynExtensionTypes.h
 * @brief:  Implementation of the DynExtensionTypes class
 * @author: SBMLTeam
 *
 * <!--------------------------------------------------------------------------
 ...
 * ------------------------------------------------------------------------ -->
 */
#ifndef DynExtensionTypes_H
#define DynExtensionTypes_H
